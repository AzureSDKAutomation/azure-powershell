...
### Delete (Default)
```
Remove-AzOperationalInsightsLinkedService -Name <String> -ResourceGroupName <String> -WorkspaceName <String>
...
### DeleteViaIdentity
```
Remove-AzOperationalInsightsLinkedService -InputObject <IOperationalInsightsIdentity>
