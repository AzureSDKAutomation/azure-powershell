...
### Delete (Default)
```
Remove-AzOperationalInsightsSavedSearch -Id <String> -ResourceGroupName <String> -WorkspaceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzOperationalInsightsSavedSearch -InputObject <IOperationalInsightsIdentity>
