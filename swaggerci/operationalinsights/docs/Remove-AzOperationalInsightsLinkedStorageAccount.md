...
### Delete (Default)
```
Remove-AzOperationalInsightsLinkedStorageAccount -DataSourceType <DataSourceType> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzOperationalInsightsLinkedStorageAccount -InputObject <IOperationalInsightsIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Support.DataSourceType
