...
### Get
```
Get-AzOperationalInsightsLinkedStorageAccount -DataSourceType <DataSourceType> -ResourceGroupName <String>
 -WorkspaceName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzOperationalInsightsLinkedStorageAccount -InputObject <IOperationalInsightsIdentity>
