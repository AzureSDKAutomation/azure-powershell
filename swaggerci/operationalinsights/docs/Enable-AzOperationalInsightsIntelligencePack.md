...
online version: https://docs.microsoft.com/en-us/powershell/module/az.operationalinsights/enable-azoperationalinsightsintelligencepack
schema: 2.0.0
---
...
### Enable (Default)
```
Enable-AzOperationalInsightsIntelligencePack -Name <String> -ResourceGroupName <String>
...
### EnableViaIdentity
```
Enable-AzOperationalInsightsIntelligencePack -InputObject <IOperationalInsightsIdentity>
