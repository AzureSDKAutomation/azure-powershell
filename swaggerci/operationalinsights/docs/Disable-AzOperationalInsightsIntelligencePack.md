...
online version: https://docs.microsoft.com/en-us/powershell/module/az.operationalinsights/disable-azoperationalinsightsintelligencepack
schema: 2.0.0
---

# Disable-AzOperationalInsightsIntelligencePack
...
### Disable (Default)
```
Disable-AzOperationalInsightsIntelligencePack -Name <String> -ResourceGroupName <String>
...
### DisableViaIdentity
```
Disable-AzOperationalInsightsIntelligencePack -InputObject <IOperationalInsightsIdentity>
