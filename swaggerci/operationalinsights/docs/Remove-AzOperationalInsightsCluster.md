...
### Delete (Default)
```
Remove-AzOperationalInsightsCluster -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzOperationalInsightsCluster -InputObject <IOperationalInsightsIdentity> [-DefaultProfile <PSObject>]
