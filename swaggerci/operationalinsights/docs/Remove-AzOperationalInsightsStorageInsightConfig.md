...
online version: https://docs.microsoft.com/en-us/powershell/module/az.operationalinsights/remove-azoperationalinsightsstorageinsightconfig
schema: 2.0.0
---

# Remove-AzOperationalInsightsStorageInsightConfig
...
### Delete (Default)
```
Remove-AzOperationalInsightsStorageInsightConfig -ResourceGroupName <String> -StorageInsightName <String>
...
### DeleteViaIdentity
```
Remove-AzOperationalInsightsStorageInsightConfig -InputObject <IOperationalInsightsIdentity>
