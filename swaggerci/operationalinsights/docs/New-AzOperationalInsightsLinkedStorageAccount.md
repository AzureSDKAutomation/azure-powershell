...
```
New-AzOperationalInsightsLinkedStorageAccount -DataSourceType <DataSourceType> -ResourceGroupName <String>
 -WorkspaceName <String> [-SubscriptionId <String>] [-StorageAccountId <String[]>]
