...
namespace Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/dataExports/{dataExportName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzOperationalInsightsDataExport_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Description(@"Create or update a data export.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Generated]
    public partial class NewAzOperationalInsightsDataExport_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The latest data export rule modification time.")]
        ...
        public string CreatedDate { get => ParametersBody.CreatedDate ?? null; set => ParametersBody.CreatedDate = value; }

        /// <summary>The data export rule ID.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The data export rule ID.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string DataExportId { get => ParametersBody.DataExportId ?? null; set => ParametersBody.DataExportId = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The destination resource ID. This can be copied from the Properties entry of the destination resource in Azure.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Active when enabled.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public global::System.Management.Automation.SwitchParameter Enable { get => ParametersBody.Enable ?? default(global::System.Management.Automation.SwitchParameter); set => ParametersBody.Enable = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Date and time when the export was last modified.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string LastModifiedDate { get => ParametersBody.LastModifiedDate ?? null; set => ParametersBody.LastModifiedDate = value; }

        /// <summary>
        /// Optional. Allows to define an Event Hub name. Not applicable when destination is Storage Account.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Optional. Allows to define an Event Hub name. Not applicable when destination is Storage Account.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string MetaDataEventHubName { get => ParametersBody.MetaDataEventHubName ?? null; set => ParametersBody.MetaDataEventHubName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The data export rule name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("DataExportName")]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.DataExport();

        /// <summary>The top level data export resource container.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "An array of tables to export, for example: [“Heartbeat, SecurityEvent”].")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string[] TableName { get => ParametersBody.TableName ?? null /* arrayOf */; set => ParametersBody.TableName = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onCreated method should be processed, or if the method should
        /// return immediately (set to true to skip further processing )</param>

        partial void overrideOnCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzOperationalInsightsDataExport_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzOperationalInsightsDataExport_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DataExportsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DataExportsCreateOrUpdate(SubscriptionId, ResourceGroupName, WorkspaceName, Name, ParametersBody, onOk, onCreated, onDefault, this, Pipeline);
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onCreated(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.IDataExport> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
