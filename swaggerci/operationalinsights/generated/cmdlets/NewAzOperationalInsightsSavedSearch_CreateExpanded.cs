...
namespace Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}/providers/Microsoft.OperationalInsights/workspaces/{workspaceName}/savedSearches/{savedSearchId}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzOperationalInsightsSavedSearch_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Description(@"Creates or updates a saved search for a given workspace.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Generated]
    public partial class NewAzOperationalInsightsSavedSearch_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.IEventListener
    {
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The category of the saved search. This helps the user to find a saved search faster. ")]
        ...
        public string Category { get => ParametersBody.Category ?? null; set => ParametersBody.Category = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Saved search display name.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The ETag of the saved search.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The function alias if query serves as a function.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string FunctionAlias { get => ParametersBody.FunctionAlias ?? null; set => ParametersBody.FunctionAlias = value; }
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The optional function parameters if query serves as a function. Value should be in the following format: 'param-name1:type1 = default_value1, param-name2:type2 = default_value2'. For more examples and proper syntax please refer to https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string FunctionParameter { get => ParametersBody.FunctionParameter ?? null; set => ParametersBody.FunctionParameter = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The id of the saved search.")]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("SavedSearchId")]
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch _parametersBody= new Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.SavedSearch();

        /// <summary>Value object for saved search results.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch ParametersBody { get => this._parametersBody; set => this._parametersBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The query expression for the saved search.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Query { get => ParametersBody.Query ?? null; set => ParametersBody.Query = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The tags attached to the saved search.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ITag[] Tag { get => ParametersBody.Tag ?? null /* arrayOf */; set => ParametersBody.Tag = value; }

        /// <summary>
        /// The version number of the query language. The current version is 2 and is the default.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The version number of the query language. The current version is 2 and is the default.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Category(global::Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public long Version { get => ParametersBody.Version ?? default(long); set => ParametersBody.Version = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzOperationalInsightsSavedSearch_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzOperationalInsightsSavedSearch_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'SavedSearchesCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.SavedSearchesCreateOrUpdate(SubscriptionId, ResourceGroupName, WorkspaceName, Id, ParametersBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,WorkspaceName=WorkspaceName,Id=Id,body=ParametersBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20200801.ISavedSearch
