...
namespace Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Support";
