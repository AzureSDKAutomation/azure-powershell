...
using Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
