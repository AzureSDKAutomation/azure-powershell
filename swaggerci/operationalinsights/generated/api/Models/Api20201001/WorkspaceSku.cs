namespace Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20201001
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20201001.IWorkspaceSkuInternal
    {
        ...
        /// <summary>Backing field for <see cref="MaxCapacityReservationLevel" /> property.</summary>
        private int? _maxCapacityReservationLevel;

        /// <summary>
        /// The maximum capacity reservation level available for this workspace, when CapacityReservation sku is selected.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Origin(Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.PropertyOrigin.Owned)]
        public int? MaxCapacityReservationLevel { get => this._maxCapacityReservationLevel; }
        ...
        /// <summary>Internal Acessors for MaxCapacityReservationLevel</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Models.Api20201001.IWorkspaceSkuInternal.MaxCapacityReservationLevel { get => this._maxCapacityReservationLevel; set { {_maxCapacityReservationLevel = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(int) })]
        int? MaxCapacityReservationLevel { get;  }
        /// <summary>The name of the SKU.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Runtime.Info(
        Required = true,
        ReadOnly = false,
...

    {
        ...
        /// The maximum capacity reservation level available for this workspace, when CapacityReservation sku is selected.
        /// </summary>
        int? MaxCapacityReservationLevel { get; set; }
        /// <summary>The name of the SKU.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.OperationalInsights.Support.WorkspaceSkuNameEnum Name { get; set; }
