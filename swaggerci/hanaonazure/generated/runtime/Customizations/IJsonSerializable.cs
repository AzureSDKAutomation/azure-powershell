...
using Microsoft.Azure.PowerShell.Cmdlets.Hana.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.Hana.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.Hana.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.Hana.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
