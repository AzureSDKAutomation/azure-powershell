namespace Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview
{
    ...
    public partial class Display :
        Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplay,
        Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplayInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplayInternal.Description { get => this._description; set { {_description = value;} } }

        /// <summary>Internal Acessors for Operation</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplayInternal.Operation { get => this._operation; set { {_operation = value;} } }

        /// <summary>Internal Acessors for Origin</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplayInternal.Origin { get => this._origin; set { {_origin = value;} } }

        /// <summary>Internal Acessors for Provider</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplayInternal.Provider { get => this._provider; set { {_provider = value;} } }

        /// <summary>Internal Acessors for Resource</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Hana.Models.Api20200207Preview.IDisplayInternal.Resource { get => this._resource; set { {_resource = value;} } }
