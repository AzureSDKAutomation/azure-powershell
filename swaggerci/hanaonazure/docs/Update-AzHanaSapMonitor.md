...
external help file:
Module Name: Az.Hana
online version: https://docs.microsoft.com/en-us/powershell/module/az.hana/update-azhanasapmonitor
schema: 2.0.0
---

# Update-AzHanaSapMonitor
...
```
Update-AzHanaSapMonitor -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzHanaSapMonitor -InputObject <IHanaIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
