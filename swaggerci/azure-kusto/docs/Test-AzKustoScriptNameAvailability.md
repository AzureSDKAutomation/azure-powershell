...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kusto/test-azkustoscriptnameavailability
schema: 2.0.0
---
...
```
Test-AzKustoScriptNameAvailability -ClusterName <String> -DatabaseName <String> -ResourceGroupName <String>
 -ScriptName <IScriptCheckNameRequest> [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzKustoScriptNameAvailability -InputObject <IKustoIdentity> -ScriptName <IScriptCheckNameRequest>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IScriptCheckNameRequest
