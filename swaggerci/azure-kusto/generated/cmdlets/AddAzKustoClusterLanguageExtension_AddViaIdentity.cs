...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Add, @"AzKustoClusterLanguageExtension_AddViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class AddAzKustoClusterLanguageExtension_AddViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="LanguageExtensionsToAdd" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList _languageExtensionsToAdd;
        ...
        SerializedName = @"languageExtensionsToAdd",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList LanguageExtensionsToAdd { get => this._languageExtensionsToAdd; set => this._languageExtensionsToAdd = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzKustoClusterLanguageExtension_AddViaIdentity" /> cmdlet class.
        /// </summary>
        public AddAzKustoClusterLanguageExtension_AddViaIdentity()
        {
        ...
        /// <returns>a duplicate instance of AddAzKustoClusterLanguageExtension_AddViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.AddAzKustoClusterLanguageExtension_AddViaIdentity Clone()
        {
            var clone = new AddAzKustoClusterLanguageExtension_AddViaIdentity();
            ...
            clone.LanguageExtensionsToAdd = this.LanguageExtensionsToAdd;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersAddLanguageExtensionsViaIdentity(InputObject.Id, LanguageExtensionsToAdd, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersAddLanguageExtensions(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, LanguageExtensionsToAdd, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=LanguageExtensionsToAdd})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToAdd })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToAdd })
                    {
