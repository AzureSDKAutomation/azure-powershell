...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzKustoDetachClusterFollowerDatabase_Detach", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzKustoDetachClusterFollowerDatabase_Detach : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="FollowerDatabaseToRemove" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IFollowerDatabaseDefinition _followerDatabaseToRemove;

        /// <summary>A class representing follower database request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A class representing follower database request.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"A class representing follower database request.",
        SerializedName = @"followerDatabaseToRemove",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IFollowerDatabaseDefinition) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IFollowerDatabaseDefinition FollowerDatabaseToRemove { get => this._followerDatabaseToRemove; set => this._followerDatabaseToRemove = value; }
        ...
        /// <returns>a duplicate instance of InvokeAzKustoDetachClusterFollowerDatabase_Detach</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.InvokeAzKustoDetachClusterFollowerDatabase_Detach Clone()
        {
            var clone = new InvokeAzKustoDetachClusterFollowerDatabase_Detach();
            ...
            clone.FollowerDatabaseToRemove = this.FollowerDatabaseToRemove;
            return clone;
        }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzKustoDetachClusterFollowerDatabase_Detach" /> cmdlet class.
        /// </summary>
        public InvokeAzKustoDetachClusterFollowerDatabase_Detach()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ClustersDetachFollowerDatabases(ResourceGroupName, ClusterName, SubscriptionId, FollowerDatabaseToRemove, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,SubscriptionId=SubscriptionId,body=FollowerDatabaseToRemove})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, SubscriptionId=SubscriptionId, body=FollowerDatabaseToRemove })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, SubscriptionId=SubscriptionId, body=FollowerDatabaseToRemove })
                    {
