...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzKustoClusterNameAvailability_Check", SupportsShouldProcess = true)]
    ...
    public partial class TestAzKustoClusterNameAvailability_Check : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterCheckNameRequest _clusterName;

        /// <summary>The result returned from a cluster check name availability request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The result returned from a cluster check name availability request.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The result returned from a cluster check name availability request.",
        SerializedName = @"clusterName",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterCheckNameRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterCheckNameRequest ClusterName { get => this._clusterName; set => this._clusterName = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ClustersCheckNameAvailability(SubscriptionId, Location, ClusterName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,Location=Location,body=ClusterName})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzKustoClusterNameAvailability_Check" /> cmdlet class.
        /// </summary>
        public TestAzKustoClusterNameAvailability_Check()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=ClusterName })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, Location=Location, body=ClusterName })
                    {
