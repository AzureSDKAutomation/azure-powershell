...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] RemoveLanguageExtensions=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/removeLanguageExtensions"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzKustoClusterLanguageExtension_RemoveViaIdentityExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(bool))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Description(@"Remove a list of language extensions that can run within KQL queries.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Generated]
    public partial class RemoveAzKustoClusterLanguageExtension_RemoveViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList _languageExtensionsToRemoveBody= new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.LanguageExtensionsList();

        /// <summary>The list of language extension objects.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList LanguageExtensionsToRemoveBody { get => this._languageExtensionsToRemoveBody; set => this._languageExtensionsToRemoveBody = value; }
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtension) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtension[] Value { get => LanguageExtensionsToRemoveBody.Value ?? null /* arrayOf */; set => LanguageExtensionsToRemoveBody.Value = value; }
        ...
        /// <returns>
        /// a duplicate instance of RemoveAzKustoClusterLanguageExtension_RemoveViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.RemoveAzKustoClusterLanguageExtension_RemoveViaIdentityExpanded Clone()
        {
            var clone = new RemoveAzKustoClusterLanguageExtension_RemoveViaIdentityExpanded();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClustersRemoveLanguageExtensions' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersRemoveLanguageExtensionsViaIdentity(InputObject.Id, LanguageExtensionsToRemoveBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersRemoveLanguageExtensions(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, LanguageExtensionsToRemoveBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=LanguageExtensionsToRemoveBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzKustoClusterLanguageExtension_RemoveViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public RemoveAzKustoClusterLanguageExtension_RemoveViaIdentityExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToRemoveBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToRemoveBody })
                    {
