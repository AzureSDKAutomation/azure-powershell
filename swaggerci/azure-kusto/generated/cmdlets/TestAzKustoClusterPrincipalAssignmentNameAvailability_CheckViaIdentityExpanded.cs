...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CheckNameAvailability=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/checkPrincipalAssignmentNameAvailability"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzKustoClusterPrincipalAssignmentNameAvailability_CheckViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    public partial class TestAzKustoClusterPrincipalAssignmentNameAvailability_CheckViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterPrincipalAssignmentCheckNameRequest _principalAssignmentNameBody= new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ClusterPrincipalAssignmentCheckNameRequest();

        /// <summary>A principal assignment check name availability request.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IClusterPrincipalAssignmentCheckNameRequest PrincipalAssignmentNameBody { get => this._principalAssignmentNameBody; set => this._principalAssignmentNameBody = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClusterPrincipalAssignmentsCheckNameAvailability' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClusterPrincipalAssignmentsCheckNameAvailabilityViaIdentity(InputObject.Id, PrincipalAssignmentNameBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClusterPrincipalAssignmentsCheckNameAvailability(InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.SubscriptionId ?? null, PrincipalAssignmentNameBody, onOk, onDefault, this, Pipeline);
                    }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzKustoClusterPrincipalAssignmentNameAvailability_CheckViaIdentityExpanded"
        /// /> cmdlet class.
        /// </summary>
        public TestAzKustoClusterPrincipalAssignmentNameAvailability_CheckViaIdentityExpanded()
        {
