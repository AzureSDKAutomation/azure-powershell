...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CheckNameAvailability=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Kusto/clusters/{clusterName}/checkNameAvailability"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzKustoDatabaseNameAvailability_CheckExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Description(@"Checks that the database name is valid and is not already in use.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Generated]
    public partial class TestAzKustoDatabaseNameAvailability_CheckExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        SerializedName = @"name",
        PossibleTypes = new [] { typeof(string) })]
        public string Name { get => ResourceNameBody.Name ?? null; set => ResourceNameBody.Name = value; }
        ...
        /// <summary>Backing field for <see cref="ResourceNameBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICheckNameRequest _resourceNameBody= new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.CheckNameRequest();

        /// <summary>The result returned from a database check name availability request.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICheckNameRequest ResourceNameBody { get => this._resourceNameBody; set => this._resourceNameBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The type of resource, for instance Microsoft.Kusto/clusters/databases.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Kusto.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.Type))]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Support.Type Type { get => ResourceNameBody.Type; set => ResourceNameBody.Type = value; }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'DatabasesCheckNameAvailability' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.DatabasesCheckNameAvailability(ResourceGroupName, ClusterName, SubscriptionId, ResourceNameBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,SubscriptionId=SubscriptionId,body=ResourceNameBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzKustoDatabaseNameAvailability_CheckExpanded" /> cmdlet class.
        /// </summary>
        public TestAzKustoDatabaseNameAvailability_CheckExpanded()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, SubscriptionId=SubscriptionId, body=ResourceNameBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, SubscriptionId=SubscriptionId, body=ResourceNameBody })
                    {
