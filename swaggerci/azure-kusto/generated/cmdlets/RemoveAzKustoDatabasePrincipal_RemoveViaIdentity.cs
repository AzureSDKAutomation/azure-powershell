...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzKustoDatabasePrincipal_RemoveViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzKustoDatabasePrincipal_RemoveViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="DatabasePrincipalsToRemove" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabasePrincipalListRequest _databasePrincipalsToRemove;

        /// <summary>The list Kusto database principals operation request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The list Kusto database principals operation request.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The list Kusto database principals operation request.",
        SerializedName = @"databasePrincipalsToRemove",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabasePrincipalListRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabasePrincipalListRequest DatabasePrincipalsToRemove { get => this._databasePrincipalsToRemove; set => this._databasePrincipalsToRemove = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DatabasesRemovePrincipalsViaIdentity(InputObject.Id, DatabasePrincipalsToRemove, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DatabasesRemovePrincipals(InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.DatabaseName ?? null, InputObject.SubscriptionId ?? null, DatabasePrincipalsToRemove, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=DatabasePrincipalsToRemove})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzKustoDatabasePrincipal_RemoveViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzKustoDatabasePrincipal_RemoveViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DatabasePrincipalsToRemove })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=DatabasePrincipalsToRemove })
                    {
