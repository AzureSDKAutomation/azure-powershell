...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    public partial class AddAzKustoClusterLanguageExtension_AddViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="LanguageExtensionsToAddBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList _languageExtensionsToAddBody= new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.LanguageExtensionsList();

        /// <summary>The list of language extension objects.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList LanguageExtensionsToAddBody { get => this._languageExtensionsToAddBody; set => this._languageExtensionsToAddBody = value; }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtension[] Value { get => LanguageExtensionsToAddBody.Value ?? null /* arrayOf */; set => LanguageExtensionsToAddBody.Value = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="AddAzKustoClusterLanguageExtension_AddViaIdentityExpanded" /> cmdlet class.
        /// </summary>
        public AddAzKustoClusterLanguageExtension_AddViaIdentityExpanded()
        {
        ...
        /// <returns>
        /// a duplicate instance of AddAzKustoClusterLanguageExtension_AddViaIdentityExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.AddAzKustoClusterLanguageExtension_AddViaIdentityExpanded Clone()
        {
            var clone = new AddAzKustoClusterLanguageExtension_AddViaIdentityExpanded();
            ...
            clone.LanguageExtensionsToAddBody = this.LanguageExtensionsToAddBody;
            return clone;
        }
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'ClustersAddLanguageExtensions' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersAddLanguageExtensionsViaIdentity(InputObject.Id, LanguageExtensionsToAddBody, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersAddLanguageExtensions(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, LanguageExtensionsToAddBody, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=LanguageExtensionsToAddBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToAddBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToAddBody })
                    {
