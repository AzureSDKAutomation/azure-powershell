...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzKustoClusterLanguageExtension_RemoveViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class RemoveAzKustoClusterLanguageExtension_RemoveViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="LanguageExtensionsToRemove" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList _languageExtensionsToRemove;

        /// <summary>The list of language extension objects.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The list of language extension objects.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"The list of language extension objects.",
        SerializedName = @"languageExtensionsToRemove",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ILanguageExtensionsList LanguageExtensionsToRemove { get => this._languageExtensionsToRemove; set => this._languageExtensionsToRemove = value; }
        ...
        /// <returns>a duplicate instance of RemoveAzKustoClusterLanguageExtension_RemoveViaIdentity</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.RemoveAzKustoClusterLanguageExtension_RemoveViaIdentity Clone()
        {
            var clone = new RemoveAzKustoClusterLanguageExtension_RemoveViaIdentity();
            ...
            clone.LanguageExtensionsToRemove = this.LanguageExtensionsToRemove;
            return clone;
        }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ClustersRemoveLanguageExtensionsViaIdentity(InputObject.Id, LanguageExtensionsToRemove, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ClustersRemoveLanguageExtensions(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, LanguageExtensionsToRemove, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=LanguageExtensionsToRemove})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzKustoClusterLanguageExtension_RemoveViaIdentity" /> cmdlet class.
        /// </summary>
        public RemoveAzKustoClusterLanguageExtension_RemoveViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToRemove })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=LanguageExtensionsToRemove })
                    {
