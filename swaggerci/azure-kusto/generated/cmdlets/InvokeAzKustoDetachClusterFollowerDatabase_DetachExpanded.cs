...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzKustoDetachClusterFollowerDatabase_DetachExpanded", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzKustoDetachClusterFollowerDatabase_DetachExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IFollowerDatabaseDefinition _followerDatabaseToRemoveBody= new Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.FollowerDatabaseDefinition();

        /// <summary>A class representing follower database request.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IFollowerDatabaseDefinition FollowerDatabaseToRemoveBody { get => this._followerDatabaseToRemoveBody; set => this._followerDatabaseToRemoveBody = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzKustoDetachClusterFollowerDatabase_DetachExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets.InvokeAzKustoDetachClusterFollowerDatabase_DetachExpanded Clone()
        {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzKustoDetachClusterFollowerDatabase_DetachExpanded" /> cmdlet class.
        /// </summary>
        public InvokeAzKustoDetachClusterFollowerDatabase_DetachExpanded()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ClustersDetachFollowerDatabases(ResourceGroupName, ClusterName, SubscriptionId, FollowerDatabaseToRemoveBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,ClusterName=ClusterName,SubscriptionId=SubscriptionId,body=FollowerDatabaseToRemoveBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, SubscriptionId=SubscriptionId, body=FollowerDatabaseToRemoveBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, ClusterName=ClusterName, SubscriptionId=SubscriptionId, body=FollowerDatabaseToRemoveBody })
                    {
