...
namespace Microsoft.Azure.PowerShell.Cmdlets.Kusto.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzKustoDatabasePrincipalAssignmentNameAvailability_CheckViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class TestAzKustoDatabasePrincipalAssignmentNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabasePrincipalAssignmentCheckNameRequest _principalAssignmentName;

        /// <summary>A principal assignment check name availability request.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "A principal assignment check name availability request.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.Kusto.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"A principal assignment check name availability request.",
        SerializedName = @"principalAssignmentName",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabasePrincipalAssignmentCheckNameRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.IDatabasePrincipalAssignmentCheckNameRequest PrincipalAssignmentName { get => this._principalAssignmentName; set => this._principalAssignmentName = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.DatabasePrincipalAssignmentsCheckNameAvailabilityViaIdentity(InputObject.Id, PrincipalAssignmentName, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.DatabasePrincipalAssignmentsCheckNameAvailability(InputObject.ResourceGroupName ?? null, InputObject.ClusterName ?? null, InputObject.DatabaseName ?? null, InputObject.SubscriptionId ?? null, PrincipalAssignmentName, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=PrincipalAssignmentName})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzKustoDatabasePrincipalAssignmentNameAvailability_CheckViaIdentity" />
        /// cmdlet class.
        /// </summary>
        public TestAzKustoDatabasePrincipalAssignmentNameAvailability_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Kusto.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PrincipalAssignmentName })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=PrincipalAssignmentName })
                    {
