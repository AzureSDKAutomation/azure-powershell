...
online version: https://docs.microsoft.com/en-us/powershell/module/az.domainservices/update-azdomainservicesoucontainer
schema: 2.0.0
---

# Update-AzDomainServicesOuContainer
...
```
Update-AzDomainServicesOuContainer -DomainServiceName <String> -Name <String> -ResourceGroupName <String>
 [-SubscriptionId <String>] [-AccountName <String>] [-Password <String>] [-Spn <String>]
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzDomainServicesOuContainer -InputObject <IDomainServicesIdentity> [-AccountName <String>]
 [-Password <String>] [-Spn <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
