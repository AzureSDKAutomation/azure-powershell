...
online version: https://docs.microsoft.com/en-us/powershell/module/az.domainservices/new-azdomainservicesdomainservice
schema: 2.0.0
---

# New-AzDomainServicesDomainService
...
```
New-AzDomainServicesDomainService -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
