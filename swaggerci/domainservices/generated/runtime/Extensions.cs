 ...
 *--------------------------------------------------------------------------------------------*/
namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime
{
    using System.Linq;
    ...
    internal static partial class Extensions
    {
        ...
        internal static void AddIf<T>(T value, System.Action<T> addMethod)
        {
            ...
            if (null != value && (value as Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject)?.Keys.Count != 0)
            {
                addMethod(value);
            }
        }
