namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20
{
    ...
    public partial class SystemData :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20.ISystemData,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20.ISystemDataInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType? _createdByType;

        /// <summary>The type of identity that created the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType? CreatedByType { get => this._createdByType; set => this._createdByType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType? _lastModifiedByType;

        /// <summary>The type of identity that last modified the resource.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType? LastModifiedByType { get => this._lastModifiedByType; set => this._lastModifiedByType = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType? CreatedByType { get; set; }
        /// <summary>The timestamp of resource last modification (UTC)</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType) })]
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.CreatedByType? LastModifiedByType { get; set; }
