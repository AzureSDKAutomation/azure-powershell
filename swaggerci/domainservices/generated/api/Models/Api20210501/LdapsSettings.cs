namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501
{
    ...
    public partial class LdapsSettings :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.ILdapsSettings,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.ILdapsSettingsInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.ExternalAccess? _externalAccess;

        /// <summary>
        /// A flag to determine whether or not Secure LDAP access over the internet is enabled or disabled.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.ExternalAccess? ExternalAccess { get => this._externalAccess; set => this._externalAccess = value; }

        /// <summary>Backing field for <see cref="Ldap" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Ldaps? _ldap;

        /// <summary>A flag to determine whether or not Secure LDAP is enabled or disabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Ldaps? Ldap { get => this._ldap; set => this._ldap = value; }

        /// <summary>Internal Acessors for CertificateNotAfter</summary>
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.ILdapsSettingsInternal.CertificateNotAfter { get => this._certificateNotAfter; set { {_certificateNotAfter = value;} } }

        /// <summary>Internal Acessors for CertificateThumbprint</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.ILdapsSettingsInternal.CertificateThumbprint { get => this._certificateThumbprint; set { {_certificateThumbprint = value;} } }

        /// <summary>Internal Acessors for PublicCertificate</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.ILdapsSettingsInternal.PublicCertificate { get => this._publicCertificate; set { {_publicCertificate = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.ExternalAccess? ExternalAccess { get; set; }
        /// <summary>A flag to determine whether or not Secure LDAP is enabled or disabled.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Support.Ldaps? Ldap { get; set; }
        /// <summary>
        /// The certificate required to configure Secure LDAP. The parameter passed here should be a base64encoded representation
        /// of the certificate pfx file.
        /// </summary>
