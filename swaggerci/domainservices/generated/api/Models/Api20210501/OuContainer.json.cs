namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501
{
    ...
    public partial class OuContainer
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IOuContainer.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IOuContainer.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IOuContainer FromJson(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject json ? new OuContainer(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject into a new instance of <see cref="OuContainer" />.
        /// </summary>
        ...
        internal OuContainer(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject json)
        {
            ...
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.OuContainerProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="OuContainer" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OuContainer" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode" />.
        /// </returns>
