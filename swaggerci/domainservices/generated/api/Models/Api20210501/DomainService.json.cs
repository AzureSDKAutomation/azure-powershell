namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501
{
    ...
    public partial class DomainService
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject into a new instance of <see cref="DomainService" />.
        /// </summary>
        ...
        internal DomainService(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.Resource(json);
            {_property = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject>("properties"), out var __jsonProperties) ? Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.DomainServiceProperties.FromJson(__jsonProperties) : Property;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService FromJson(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject json ? new DomainService(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DomainService" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DomainService" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._property ? (Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.Json.JsonNode) this._property.ToJson(null,serializationMode) : null, "properties" ,container.Add );
