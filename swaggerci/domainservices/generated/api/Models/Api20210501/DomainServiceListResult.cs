namespace Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501
{
    ...
    public partial class DomainServiceListResult :
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainServiceListResult,
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainServiceListResultInternal
    {

        /// <summary>Internal Acessors for NextLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainServiceListResultInternal.NextLink { get => this._nextLink; set { {_nextLink = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService[] _value;

        /// <summary>the list of domain services.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService[] Value { get => this._value; set => this._value = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService) })]
        Microsoft.Azure.PowerShell.Cmdlets.DomainServices.Models.Api20210501.IDomainService[] Value { get; set; }
