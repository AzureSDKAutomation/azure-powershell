...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/new-azcommunicationservicekey
schema: 2.0.0
---
...
```
New-AzCommunicationServiceKey -InputObject <ICommunicationServiceIdentity>
 -Parameter <IRegenerateKeyParameters> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RegenerateViaIdentityExpanded
```
New-AzCommunicationServiceKey -InputObject <ICommunicationServiceIdentity> [-KeyType <KeyType>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.KeyType
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IRegenerateKeyParameters
