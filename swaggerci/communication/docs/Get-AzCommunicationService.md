...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/get-azcommunicationservice
schema: 2.0.0
---
...
### GetViaIdentity
```
Get-AzCommunicationService -InputObject <ICommunicationServiceIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
