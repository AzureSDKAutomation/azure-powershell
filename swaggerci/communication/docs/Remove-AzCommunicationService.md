...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/remove-azcommunicationservice
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-AzCommunicationService -InputObject <ICommunicationServiceIdentity> [-DefaultProfile <PSObject>]
