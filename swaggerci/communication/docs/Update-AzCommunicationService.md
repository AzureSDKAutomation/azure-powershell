...
online version: https://docs.microsoft.com/en-us/powershell/module/az.communicationservice/update-azcommunicationservice
schema: 2.0.0
---
...
```
Update-AzCommunicationService -InputObject <ICommunicationServiceIdentity> [-DataLocation <String>]
