namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview
{
    ...
    public partial class Resource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IResource.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonObject json ? new Resource(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonObject into a new instance of <see cref="Resource" />.
        /// </summary>
        ...
        internal Resource(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonObject json)
        {
            ...
            {_type = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonString>("type"), out var __jsonType) ? (string)__jsonType : (string)Type;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="Resource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="Resource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.SerializationMode serializationMode)
        {
            ...
            if (serializationMode.HasFlag(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.SerializationMode.IncludeReadOnly))
            {
                AddIf( null != (((object)this._type)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Json.JsonString(this._type.ToString()) : null, "type" ,container.Add );
            }
