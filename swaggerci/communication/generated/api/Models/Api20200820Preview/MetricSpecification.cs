namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview
{
    ...
    public partial class MetricSpecification :
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IMetricSpecification,
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IMetricSpecificationInternal
    {

        /// <summary>Backing field for <see cref="AggregationType" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType? _aggregationType;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType? AggregationType { get => this._aggregationType; set => this._aggregationType = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IDimension[] _dimension;

        /// <summary>The dimensions of the metrics.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Origin(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IDimension[] Dimension { get => this._dimension; set => this._dimension = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType) })]
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType? AggregationType { get; set; }
        /// <summary>
        /// The name of the metric category that the metric belongs to. A metric can only belong to a single category.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Info(
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IDimension) })]
        Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Models.Api20200820Preview.IDimension[] Dimension { get; set; }
        /// <summary>Localized friendly description of the metric.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Runtime.Info(
        Required = false,
        ReadOnly = false,
