...
namespace Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType Average = @"Average";

        public static Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType Count = @"Count";

        public static Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType Maximum = @"Maximum";

        public static Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType Minimum = @"Minimum";

        public static Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType Total = @"Total";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType e1, Microsoft.Azure.PowerShell.Cmdlets.CommunicationService.Support.AggregationType e2)
        {
            return !e2.Equals(e1);
        }
