...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] CheckNameAvailability=>POST:"/subscriptions/{subscriptionId}/providers/Microsoft.Blockchain/locations/{locationName}/checkNameAvailability"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzBlockchainLocationNameAvailability_CheckViaIdentityExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Description(@"To check whether a resource name is available.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Generated]
    public partial class TestAzBlockchainLocationNameAvailability_CheckViaIdentityExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Blockchain.BlockchainManagementClient Client => Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Module.Instance.ClientAPI;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.IBlockchainIdentity _inputObject;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.IBlockchainIdentity InputObject { get => this._inputObject; set => this._inputObject = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the name to check.")]
        ...
        public string Name { get => NameAvailabilityRequestBody.Name ?? null; set => NameAvailabilityRequestBody.Name = value; }

        /// <summary>Backing field for <see cref="NameAvailabilityRequestBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.INameAvailabilityRequest _nameAvailabilityRequestBody= new Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.NameAvailabilityRequest();

        /// <summary>
        /// Name availability request payload which is exposed in the request of the resource provider.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.INameAvailabilityRequest NameAvailabilityRequestBody { get => this._nameAvailabilityRequestBody; set => this._nameAvailabilityRequestBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the type of the resource to check.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        SerializedName = @"type",
        PossibleTypes = new [] { typeof(string) })]
        public string Type { get => NameAvailabilityRequestBody.Type ?? null; set => NameAvailabilityRequestBody.Type = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.INameAvailability"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.INameAvailability> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'LocationsCheckNameAvailability' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.LocationsCheckNameAvailabilityViaIdentity(InputObject.Id, NameAvailabilityRequestBody, onOk, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.LocationsCheckNameAvailability(InputObject.LocationName ?? null, InputObject.SubscriptionId ?? null, NameAvailabilityRequestBody, onOk, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=NameAvailabilityRequestBody})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzBlockchainLocationNameAvailability_CheckViaIdentityExpanded" /> cmdlet
        /// class.
        /// </summary>
        public TestAzBlockchainLocationNameAvailability_CheckViaIdentityExpanded()
        {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.INameAvailability> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.INameAvailability
