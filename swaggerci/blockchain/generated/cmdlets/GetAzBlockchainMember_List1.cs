...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Description(@"Lists the blockchain members for a subscription.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Generated]
    public partial class GetAzBlockchainMember_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzBlockchainMember_List1" /> cmdlet class.
        /// </summary>
        public GetAzBlockchainMember_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.BlockchainMembersListAll(SubscriptionId, onOk, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.BlockchainMembersListAll_Call(requestMessage, onOk, this, Pipeline);
                    }
                }
            }
        }
