...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzBlockchainTransactionNodeRegenerateApiKey_List", SupportsShouldProcess = true)]
    ...
    public partial class GetAzBlockchainTransactionNodeRegenerateApiKey_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKey _apiKey;

        /// <summary>
        /// API key payload which is exposed in the request/response of the resource provider.
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "API key payload which is exposed in the request/response of the resource provider.", ValueFromPipeline = true)]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKey ApiKey { get => this._apiKey; set => this._apiKey = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzBlockchainTransactionNodeRegenerateApiKey_List" /> cmdlet class.
        /// </summary>
        public GetAzBlockchainTransactionNodeRegenerateApiKey_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TransactionNodesListRegenerateApiKeys(BlockchainMemberName, TransactionNodeName, SubscriptionId, ResourceGroupName, ApiKey, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BlockchainMemberName=BlockchainMemberName,TransactionNodeName=TransactionNodeName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=ApiKey})
                    {
