...
namespace Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] ListRegenerateApiKeys=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Blockchain/blockchainMembers/{blockchainMemberName}/transactionNodes/{transactionNodeName}/regenerateApiKeys"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzBlockchainTransactionNodeRegenerateApiKey_ListExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKey))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Description(@"Regenerate the API keys for the blockchain member.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Generated]
    public partial class GetAzBlockchainTransactionNodeRegenerateApiKey_ListExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ApiKeyBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKey _apiKeyBody= new Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.ApiKey();

        /// <summary>
        /// API key payload which is exposed in the request/response of the resource provider.
        /// </summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKey ApiKeyBody { get => this._apiKeyBody; set => this._apiKeyBody = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the API key name.")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string KeyName { get => ApiKeyBody.KeyName ?? null; set => ApiKeyBody.KeyName = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the API key value.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Blockchain.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string Value { get => ApiKeyBody.Value ?? null; set => ApiKeyBody.Value = value; }
        ...
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKeyCollection"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKeyCollection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzBlockchainTransactionNodeRegenerateApiKey_ListExpanded" /> cmdlet class.
        /// </summary>
        public GetAzBlockchainTransactionNodeRegenerateApiKey_ListExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'TransactionNodesListRegenerateApiKeys' operation"))
                {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.TransactionNodesListRegenerateApiKeys(BlockchainMemberName, TransactionNodeName, SubscriptionId, ResourceGroupName, ApiKeyBody, onOk, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  BlockchainMemberName=BlockchainMemberName,TransactionNodeName=TransactionNodeName,SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,body=ApiKeyBody})
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Blockchain.Models.Api20180601Preview.IApiKeyCollection> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                // nested-array / keys / <none>
                WriteObject((await response).Key, true);
            }
        }
    }
}