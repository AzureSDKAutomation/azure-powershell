...
namespace Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Create=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Databricks/workspaces/{workspaceName}/privateEndpointConnections/{privateEndpointConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzDatabricksPrivateEndpointConnection_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Databricks.Description(@"Update the status of a private endpoint connection with the specified name")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.Databricks.Generated]
    public partial class NewAzDatabricksPrivateEndpointConnection_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Databricks.AzureDatabricksManagementClient Client => Microsoft.Azure.PowerShell.Cmdlets.Databricks.Module.Instance.ClientAPI;
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection _privateEndpointConnectionBody= new Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.PrivateEndpointConnection();

        /// <summary>The private endpoint connection of a workspace</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection PrivateEndpointConnectionBody { get => this._privateEndpointConnectionBody; set => this._privateEndpointConnectionBody = value; }

        /// <summary>Actions required for a private endpoint connection</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Actions required for a private endpoint connection")]
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PrivateLinkServiceConnectionStateActionRequired { get => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateActionRequired ?? null; set => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateActionRequired = value; }

        /// <summary>The description for the current state of a private endpoint connection</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The description for the current state of a private endpoint connection")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Databricks.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Databricks.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The status of a private endpoint connection")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.Databricks.Category(global::Microsoft.Azure.PowerShell.Cmdlets.Databricks.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.Databricks.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.Databricks.Support.PrivateLinkServiceConnectionStatus))]
        public Microsoft.Azure.PowerShell.Cmdlets.Databricks.Support.PrivateLinkServiceConnectionStatus PrivateLinkServiceConnectionStateStatus { get => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateStatus; set => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateStatus = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzDatabricksPrivateEndpointConnection_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Databricks.Cmdlets.NewAzDatabricksPrivateEndpointConnection_CreateExpanded Clone()
        {
            var clone = new NewAzDatabricksPrivateEndpointConnection_CreateExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzDatabricksPrivateEndpointConnection_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzDatabricksPrivateEndpointConnection_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PrivateEndpointConnectionsCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PrivateEndpointConnectionsCreate(ResourceGroupName, WorkspaceName, SubscriptionId, Name, PrivateEndpointConnectionBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  ResourceGroupName=ResourceGroupName,WorkspaceName=WorkspaceName,SubscriptionId=SubscriptionId,Name=Name,body=PrivateEndpointConnectionBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20180401.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, WorkspaceName=WorkspaceName, SubscriptionId=SubscriptionId, Name=Name, body=PrivateEndpointConnectionBody })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { ResourceGroupName=ResourceGroupName, WorkspaceName=WorkspaceName, SubscriptionId=SubscriptionId, Name=Name, body=PrivateEndpointConnectionBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.Databricks.Models.Api20210401Preview.IPrivateEndpointConnection
