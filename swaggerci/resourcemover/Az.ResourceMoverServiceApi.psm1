# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.ResourceMoverServiceApi.private.dll')

  # Get the private module's instance
  $instance = [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Module]::Instance
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.ResourceMoverServiceApi.custom.psm1'
