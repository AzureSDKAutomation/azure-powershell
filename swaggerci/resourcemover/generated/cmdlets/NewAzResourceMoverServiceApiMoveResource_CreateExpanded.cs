...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzResourceMoverServiceApiMoveResource_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Creates or updates a Move Resource in the move collection.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class NewAzResourceMoverServiceApiMoveResource_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource _body= new Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.MoveResource();

        /// <summary>Defines the move resource.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the move resource dependencies overrides.")]
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResourceDependencyOverride[] DependsOnOverride { get => Body.DependsOnOverride ?? null /* arrayOf */; set => Body.DependsOnOverride = value; }

        /// <summary>Gets or sets the existing target ARM Id of the resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the existing target ARM Id of the resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        public string ExistingTargetId { get => Body.ExistingTargetId ?? null; set => Body.ExistingTargetId = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Move Collection Name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The Move Resource Name.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        [global::System.Management.Automation.Alias("MoveResourceName")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.ParameterCategory.Path)]
        ...
        /// </summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource type. For example, the value can be Microsoft.Compute/virtualMachines.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceSettingResourceType { get => Body.ResourceSettingResourceType ?? null; set => Body.ResourceSettingResourceType = value; }

        /// <summary>Gets or sets the target Resource name.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the target Resource name.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string ResourceSettingTargetResourceName { get => Body.ResourceSettingTargetResourceName ?? null; set => Body.ResourceSettingTargetResourceName = value; }

        /// <summary>Gets or sets the Source ARM Id of the resource.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the Source ARM Id of the resource.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string SourceId { get => Body.SourceId ?? null; set => Body.SourceId = value; }
        ...
        PossibleTypes = new [] { typeof(string) })]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.DefaultInfo(
        Name = @"",
        Description =@"",
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>a duplicate instance of NewAzResourceMoverServiceApiMoveResource_CreateExpanded</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets.NewAzResourceMoverServiceApiMoveResource_CreateExpanded Clone()
        {
            var clone = new NewAzResourceMoverServiceApiMoveResource_CreateExpanded();
            ...
            clone.MoveCollectionName = this.MoveCollectionName;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzResourceMoverServiceApiMoveResource_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzResourceMoverServiceApiMoveResource_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveResourcesCreate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MoveResourcesCreate(SubscriptionId, ResourceGroupName, MoveCollectionName, Name, Body, onOk, onDefault, this, Pipeline);
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MoveCollectionName=MoveCollectionName, Name=Name, body=Body })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResource
