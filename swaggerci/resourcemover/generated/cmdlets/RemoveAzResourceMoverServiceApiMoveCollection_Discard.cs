...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Discard=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/discard"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Remove, @"AzResourceMoverServiceApiMoveCollection_Discard", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Discards the set of resources included in the request body. The discard operation is triggered on the moveResources in the moveState 'CommitPending' or 'DiscardFailed', on a successful completion the moveResource moveState do a transition to MovePending. To aid the user to prerequisite the operation the client can call operation with validateOnly property set to true.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class RemoveAzResourceMoverServiceApiMoveCollection_Discard : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IDiscardRequest _body;

        /// <summary>Defines the request body for discard operation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Defines the request body for discard operation.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IDiscardRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IDiscardRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>a duplicate instance of RemoveAzResourceMoverServiceApiMoveCollection_Discard</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets.RemoveAzResourceMoverServiceApiMoveCollection_Discard Clone()
        {
            var clone = new RemoveAzResourceMoverServiceApiMoveCollection_Discard();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveCollectionsDiscard' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MoveCollectionsDiscard(SubscriptionId, ResourceGroupName, Name, Body, onOk, onDefault, this, Pipeline);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="RemoveAzResourceMoverServiceApiMoveCollection_Discard" /> cmdlet class.
        /// </summary>
        public RemoveAzResourceMoverServiceApiMoveCollection_Discard()
        {
