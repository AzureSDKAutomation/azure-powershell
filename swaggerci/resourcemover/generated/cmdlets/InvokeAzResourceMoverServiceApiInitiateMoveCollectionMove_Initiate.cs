...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] InitiateMove=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/initiateMove"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Moves the set of resources included in the request body. The move operation is triggered after the moveResources are in the moveState 'MovePending' or 'MoveFailed', on a successful completion the moveResource moveState do a transition to CommitPending. To aid the user to prerequisite the operation the client can call operation with validateOnly property set to true.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class InvokeAzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IResourceMoveRequest _body;

        /// <summary>Defines the request body for resource move operation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Defines the request body for resource move operation.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IResourceMoveRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IResourceMoveRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets.InvokeAzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate Clone()
        {
            var clone = new InvokeAzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzResourceMoverServiceApiInitiateMoveCollectionMove_Initiate()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveCollectionsInitiateMove' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MoveCollectionsInitiateMove(SubscriptionId, ResourceGroupName, MoveCollectionName, Body, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,MoveCollectionName=MoveCollectionName,body=Body})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MoveCollectionName=MoveCollectionName, body=Body })
                    {
