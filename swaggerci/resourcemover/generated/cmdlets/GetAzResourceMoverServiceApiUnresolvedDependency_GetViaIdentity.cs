...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// <remarks>
    /// [OpenAPI] Get=>GET:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/unresolvedDependencies"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzResourceMoverServiceApiUnresolvedDependency_GetViaIdentity")]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IUnresolvedDependency))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Gets a list of unresolved dependencies.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class GetAzResourceMoverServiceApiUnresolvedDependency_GetViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="DependencyLevel" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.DependencyLevel _dependencyLevel;

        /// <summary>Defines the dependency level.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Defines the dependency level.")]
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.DependencyLevel) })]
        [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Category(global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.ParameterCategory.Query)]
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.DependencyLevel))]
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.DependencyLevel DependencyLevel { get => this._dependencyLevel; set => this._dependencyLevel = value; }

        /// <summary>Backing field for <see cref="Filter" /> property.</summary>
        private string _filter;

        /// <summary>The filter to apply on the operation. For example, $apply=filter(count eq 2).</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The filter to apply on the operation. For example, $apply=filter(count eq 2).")]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "OData order by query option. For example, you can use $orderby=Count desc.")]
        [Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IUnresolvedDependencyCollection"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IUnresolvedDependencyCollection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzResourceMoverServiceApiUnresolvedDependency_GetViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public GetAzResourceMoverServiceApiUnresolvedDependency_GetViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.UnresolvedDependenciesGetViaIdentity(InputObject.Id, this.InvocationInformation.BoundParameters.ContainsKey("DependencyLevel") ? DependencyLevel : null, this.InvocationInformation.BoundParameters.ContainsKey("Orderby") ? Orderby : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.UnresolvedDependenciesGet(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.MoveCollectionName ?? null, this.InvocationInformation.BoundParameters.ContainsKey("DependencyLevel") ? DependencyLevel : null, this.InvocationInformation.BoundParameters.ContainsKey("Orderby") ? Orderby : null, this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null, onOk, onDefault, this, Pipeline);
                    }
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { DependencyLevel=this.InvocationInformation.BoundParameters.ContainsKey("DependencyLevel") ? DependencyLevel : null, Orderby=this.InvocationInformation.BoundParameters.ContainsKey("Orderby") ? Orderby : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { DependencyLevel=this.InvocationInformation.BoundParameters.ContainsKey("DependencyLevel") ? DependencyLevel : null, Orderby=this.InvocationInformation.BoundParameters.ContainsKey("Orderby") ? Orderby : null, Filter=this.InvocationInformation.BoundParameters.ContainsKey("Filter") ? Filter : null })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IUnresolvedDependencyCollection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                if (result.NextLink != null)
                {
                    ...
                    {
                        requestMessage = requestMessage.Clone(new global::System.Uri( result.NextLink ),Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Method.Get );
                        await ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener)this).Signal(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.Events.FollowingNextLink); if( ((Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener)this).Token.IsCancellationRequested ) { return; }
                        await this.Client.UnresolvedDependenciesGet_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
