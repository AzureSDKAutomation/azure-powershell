...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] Prepare=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/prepare"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzResourceMoverServiceApiPrepareMoveCollection_Prepare", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Initiates prepare for the set of resources included in the request body. The prepare operation is on the moveResources that are in the moveState 'PreparePending' or 'PrepareFailed', on a successful completion the moveResource moveState do a transition to MovePending. To aid the user to prerequisite the operation the client can call operation with validateOnly property set to true.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class InvokeAzResourceMoverServiceApiPrepareMoveCollection_Prepare : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IPrepareRequest _body;

        /// <summary>Defines the request body for initiate prepare operation.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Defines the request body for initiate prepare operation.", ValueFromPipeline = true)]
        ...
        SerializedName = @"body",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IPrepareRequest) })]
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IPrepareRequest Body { get => this._body; set => this._body = value; }
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzResourceMoverServiceApiPrepareMoveCollection_Prepare
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets.InvokeAzResourceMoverServiceApiPrepareMoveCollection_Prepare Clone()
        {
            var clone = new InvokeAzResourceMoverServiceApiPrepareMoveCollection_Prepare();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzResourceMoverServiceApiPrepareMoveCollection_Prepare" /> cmdlet class.
        /// </summary>
        public InvokeAzResourceMoverServiceApiPrepareMoveCollection_Prepare()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveCollectionsPrepare' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MoveCollectionsPrepare(SubscriptionId, ResourceGroupName, MoveCollectionName, Body, onOk, onDefault, this, Pipeline);
