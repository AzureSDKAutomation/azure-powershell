...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] BulkRemove=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/bulkRemove"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Removes the set of move resources included in the request body from move collection. The orchestration is done by service. To aid the user to prerequisite the operation the client can call operation with validateOnly property set to true.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class InvokeAzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IBulkRemoveRequest _body= new Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.BulkRemoveRequest();

        /// <summary>Defines the request body for bulk remove of move resources operation.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IBulkRemoveRequest Body { get => this._body; set => this._body = value; }
        ...
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "Gets or sets the list of resource Id's, by default it accepts move resource id's unless the input type is switched via moveResourceInputType property.")]
        ...
        /// <returns>
        /// a duplicate instance of InvokeAzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets.InvokeAzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded Clone()
        {
            var clone = new InvokeAzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded();
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded" /> cmdlet
        /// class.
        /// </summary>
        public InvokeAzResourceMoverServiceApiBulkMoveCollectionRemove_BulkExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveCollectionsBulkRemove' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MoveCollectionsBulkRemove(SubscriptionId, ResourceGroupName, MoveCollectionName, Body, onOk, onDefault, this, Pipeline);
