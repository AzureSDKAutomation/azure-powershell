...
namespace Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] ResolveDependencies=>POST:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Migrate/moveCollections/{moveCollectionName}/resolveDependencies"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Resolve, @"AzResourceMoverServiceApiMoveCollectionDependency_Resolve", SupportsShouldProcess = true)]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Description(@"Computes, resolves and validate the dependencies of the moveResources in the move collection.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Generated]
    public partial class ResolveAzResourceMoverServiceApiMoveCollectionDependency_Resolve : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Runtime.IEventListener
    {
        ...
        /// <returns>
        /// a duplicate instance of ResolveAzResourceMoverServiceApiMoveCollectionDependency_Resolve
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Cmdlets.ResolveAzResourceMoverServiceApiMoveCollectionDependency_Resolve Clone()
        {
            var clone = new ResolveAzResourceMoverServiceApiMoveCollectionDependency_Resolve();
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'MoveCollectionsResolveDependencies' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.MoveCollectionsResolveDependencies(SubscriptionId, ResourceGroupName, MoveCollectionName, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,MoveCollectionName=MoveCollectionName})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="ResolveAzResourceMoverServiceApiMoveCollectionDependency_Resolve" /> cmdlet
        /// class.
        /// </summary>
        public ResolveAzResourceMoverServiceApiMoveCollectionDependency_Resolve()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MoveCollectionName=MoveCollectionName })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, MoveCollectionName=MoveCollectionName })
                    {
