...
online version: https://docs.microsoft.com/en-us/powershell/module/az.resourcemoverserviceapi/update-azresourcemoverserviceapimovecollection
schema: 2.0.0
---

# Update-AzResourceMoverServiceApiMoveCollection
...
```
Update-AzResourceMoverServiceApiMoveCollection -Name <String> -ResourceGroupName <String>
...
```
Update-AzResourceMoverServiceApiMoveCollection -InputObject <IResourceMoverServiceApiIdentity>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Support.ResourceIdentityType
Parameter Sets: (All)
Aliases:
