...
online version: https://docs.microsoft.com/en-us/powershell/module/az.resourcemoverserviceapi/resolve-azresourcemoverserviceapimovecollectiondependency
schema: 2.0.0
---

# Resolve-AzResourceMoverServiceApiMoveCollectionDependency
...
### Resolve (Default)
```
Resolve-AzResourceMoverServiceApiMoveCollectionDependency -MoveCollectionName <String>
...
### ResolveViaIdentity
```
Resolve-AzResourceMoverServiceApiMoveCollectionDependency -InputObject <IResourceMoverServiceApiIdentity>
