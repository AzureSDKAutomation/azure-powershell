...
online version: https://docs.microsoft.com/en-us/powershell/module/az.resourcemoverserviceapi/remove-azresourcemoverserviceapimoveresource
schema: 2.0.0
---

# Remove-AzResourceMoverServiceApiMoveResource
...
### Delete (Default)
```
Remove-AzResourceMoverServiceApiMoveResource -MoveCollectionName <String> -Name <String>
...
### DeleteViaIdentity
```
Remove-AzResourceMoverServiceApiMoveResource -InputObject <IResourceMoverServiceApiIdentity>
