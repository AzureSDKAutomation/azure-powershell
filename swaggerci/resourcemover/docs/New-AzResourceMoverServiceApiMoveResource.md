...
online version: https://docs.microsoft.com/en-us/powershell/module/az.resourcemoverserviceapi/new-azresourcemoverserviceapimoveresource
schema: 2.0.0
---
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.ResourceMoverServiceApi.Models.Api202101.IMoveResourceDependencyOverride[]
Parameter Sets: (All)
Aliases:
