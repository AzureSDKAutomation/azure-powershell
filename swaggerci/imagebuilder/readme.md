...
require:
    ...
    - $(this-folder)/../../../azure-rest-api-specs/specification/imagebuilder/resource-manager/readme.md
try-require:
    - $(this-folder)/../../../azure-rest-api-specs/specification/imagebuilder/resource-manager/readme.powershell.md
```
