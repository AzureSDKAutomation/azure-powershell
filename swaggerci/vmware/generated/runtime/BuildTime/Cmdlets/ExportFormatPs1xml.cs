...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support";
