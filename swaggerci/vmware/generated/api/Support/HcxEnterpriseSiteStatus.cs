...
namespace Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support
{
    ...
    {
        public static Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus Available = @"Available";

        public static Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus Consumed = @"Consumed";

        public static Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus Deactivated = @"Deactivated";

        public static Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus Deleted = @"Deleted";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus e1, Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.HcxEnterpriseSiteStatus e2)
        {
            return !e2.Equals(e1);
        }
