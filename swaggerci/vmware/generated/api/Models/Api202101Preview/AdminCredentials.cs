namespace Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api202101Preview
{
    ...
    public partial class AdminCredentials :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api202101Preview.IAdminCredentialsInternal
    {

        /// <summary>Internal Acessors for NsxtPassword</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api202101Preview.IAdminCredentialsInternal.NsxtPassword { get => this._nsxtPassword; set { {_nsxtPassword = value;} } }

        /// <summary>Internal Acessors for NsxtUsername</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api202101Preview.IAdminCredentialsInternal.NsxtUsername { get => this._nsxtUsername; set { {_nsxtUsername = value;} } }

        /// <summary>Internal Acessors for VcenterPassword</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api202101Preview.IAdminCredentialsInternal.VcenterPassword { get => this._vcenterPassword; set { {_vcenterPassword = value;} } }

        /// <summary>Internal Acessors for VcenterUsername</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api202101Preview.IAdminCredentialsInternal.VcenterUsername { get => this._vcenterUsername; set { {_vcenterUsername = value;} } }
