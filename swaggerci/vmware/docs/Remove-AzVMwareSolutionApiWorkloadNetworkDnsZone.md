...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiworkloadnetworkdnszone
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiWorkloadNetworkDnsZone -DnsZoneId <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiWorkloadNetworkDnsZone -InputObject <IVMwareSolutionApiIdentity>
