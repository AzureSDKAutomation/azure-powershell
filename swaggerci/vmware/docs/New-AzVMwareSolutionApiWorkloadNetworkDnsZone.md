...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiworkloadnetworkdnszone
schema: 2.0.0
---

# New-AzVMwareSolutionApiWorkloadNetworkDnsZone
...
```
New-AzVMwareSolutionApiWorkloadNetworkDnsZone -DnsZoneId <String> -PrivateCloudName <String>
