...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiscriptexecution
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiScriptExecution
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiScriptExecution -Name <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiScriptExecution -InputObject <IVMwareSolutionApiIdentity>
