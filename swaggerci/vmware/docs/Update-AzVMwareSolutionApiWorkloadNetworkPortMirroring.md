...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/update-azvmwaresolutionapiworkloadnetworkportmirroring
schema: 2.0.0
---

# Update-AzVMwareSolutionApiWorkloadNetworkPortMirroring
...
```
Update-AzVMwareSolutionApiWorkloadNetworkPortMirroring -PortMirroringId <String> -PrivateCloudName <String>
...
```
Update-AzVMwareSolutionApiWorkloadNetworkPortMirroring -InputObject <IVMwareSolutionApiIdentity>
 [-Destination <String>] [-Direction <PortMirroringDirectionEnum>] [-DisplayName <String>] [-Revision <Int64>]
 [-Source <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.PortMirroringDirectionEnum
Parameter Sets: (All)
Aliases:
