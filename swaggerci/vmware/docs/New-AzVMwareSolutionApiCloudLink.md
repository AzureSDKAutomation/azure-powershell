...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapicloudlink
schema: 2.0.0
---

# New-AzVMwareSolutionApiCloudLink
...
```
New-AzVMwareSolutionApiCloudLink -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
