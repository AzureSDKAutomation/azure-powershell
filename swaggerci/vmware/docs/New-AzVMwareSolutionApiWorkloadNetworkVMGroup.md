...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiworkloadnetworkvmgroup
schema: 2.0.0
---
...
```
New-AzVMwareSolutionApiWorkloadNetworkVMGroup -PrivateCloudName <String> -ResourceGroupName <String>
