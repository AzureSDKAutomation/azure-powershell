...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapidatastore
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiDatastore
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiDatastore -ClusterName <String> -Name <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiDatastore -InputObject <IVMwareSolutionApiIdentity> [-DefaultProfile <PSObject>]
