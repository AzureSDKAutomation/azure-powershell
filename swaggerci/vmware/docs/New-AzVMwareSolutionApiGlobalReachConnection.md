...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiglobalreachconnection
schema: 2.0.0
---

# New-AzVMwareSolutionApiGlobalReachConnection
...
```
New-AzVMwareSolutionApiGlobalReachConnection -Name <String> -PrivateCloudName <String>
