...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/update-azvmwaresolutionapiworkloadnetworksegment
schema: 2.0.0
---

# Update-AzVMwareSolutionApiWorkloadNetworkSegment
...
```
Update-AzVMwareSolutionApiWorkloadNetworkSegment -PrivateCloudName <String> -ResourceGroupName <String>
...
```
Update-AzVMwareSolutionApiWorkloadNetworkSegment -InputObject <IVMwareSolutionApiIdentity>
 [-ConnectedGateway <String>] [-DisplayName <String>] [-Revision <Int64>] [-SubnetDhcpRange <String[]>]
 [-SubnetGatewayAddress <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
