...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiworkloadnetworkdnsservice
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiWorkloadNetworkDnsService
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiWorkloadNetworkDnsService -DnsServiceId <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiWorkloadNetworkDnsService -InputObject <IVMwareSolutionApiIdentity>
