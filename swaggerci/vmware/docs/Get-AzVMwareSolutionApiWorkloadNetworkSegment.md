...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/get-azvmwaresolutionapiworkloadnetworksegment
schema: 2.0.0
---

# Get-AzVMwareSolutionApiWorkloadNetworkSegment
...
### List (Default)
```
Get-AzVMwareSolutionApiWorkloadNetworkSegment -PrivateCloudName <String> -ResourceGroupName <String>
...
```
Get-AzVMwareSolutionApiWorkloadNetworkSegment -PrivateCloudName <String> -ResourceGroupName <String>
 -SegmentId <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareSolutionApiWorkloadNetworkSegment -InputObject <IVMwareSolutionApiIdentity>
