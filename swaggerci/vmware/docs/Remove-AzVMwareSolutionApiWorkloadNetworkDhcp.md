...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiworkloadnetworkdhcp
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiWorkloadNetworkDhcp
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiWorkloadNetworkDhcp -DhcpId <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiWorkloadNetworkDhcp -InputObject <IVMwareSolutionApiIdentity>
