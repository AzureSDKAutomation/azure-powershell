...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/test-azvmwaresolutionapilocationquotaavailability
schema: 2.0.0
---

# Test-AzVMwareSolutionApiLocationQuotaAvailability
...
### Check (Default)
```
Test-AzVMwareSolutionApiLocationQuotaAvailability -Location <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzVMwareSolutionApiLocationQuotaAvailability -InputObject <IVMwareSolutionApiIdentity>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
