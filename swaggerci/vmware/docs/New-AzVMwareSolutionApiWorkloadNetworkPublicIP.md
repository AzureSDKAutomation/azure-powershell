...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiworkloadnetworkpublicip
schema: 2.0.0
---
...
```
New-AzVMwareSolutionApiWorkloadNetworkPublicIP -PrivateCloudName <String> -PublicIPId <String>
