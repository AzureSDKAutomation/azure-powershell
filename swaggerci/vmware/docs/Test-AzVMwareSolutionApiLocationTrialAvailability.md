...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/test-azvmwaresolutionapilocationtrialavailability
schema: 2.0.0
---

# Test-AzVMwareSolutionApiLocationTrialAvailability
...
### Check (Default)
```
Test-AzVMwareSolutionApiLocationTrialAvailability -Location <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzVMwareSolutionApiLocationTrialAvailability -InputObject <IVMwareSolutionApiIdentity>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
