...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/get-azvmwaresolutionapiworkloadnetworkgateway
schema: 2.0.0
---

# Get-AzVMwareSolutionApiWorkloadNetworkGateway
...
### List (Default)
```
Get-AzVMwareSolutionApiWorkloadNetworkGateway -PrivateCloudName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzVMwareSolutionApiWorkloadNetworkGateway -GatewayId <String> -PrivateCloudName <String>
 -ResourceGroupName <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareSolutionApiWorkloadNetworkGateway -InputObject <IVMwareSolutionApiIdentity>
