...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiworkloadnetworkportmirroring
schema: 2.0.0
---
...
```
New-AzVMwareSolutionApiWorkloadNetworkPortMirroring -PortMirroringId <String> -PrivateCloudName <String>
