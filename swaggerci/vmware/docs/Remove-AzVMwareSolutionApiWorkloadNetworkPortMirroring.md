...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiworkloadnetworkportmirroring
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiWorkloadNetworkPortMirroring
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiWorkloadNetworkPortMirroring -PortMirroringId <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiWorkloadNetworkPortMirroring -InputObject <IVMwareSolutionApiIdentity>
