...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapidatastore
schema: 2.0.0
---

# New-AzVMwareSolutionApiDatastore
...
```
New-AzVMwareSolutionApiDatastore -ClusterName <String> -Name <String> -PrivateCloudName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DiskPoolVolumeEndpoint <String[]>]
 [-DiskPoolVolumeLunName <String>] [-NetAppVolumeNfsFilePath <String>] [-NetAppVolumeNfsProviderIP <String>]
