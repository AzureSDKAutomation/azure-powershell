...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/update-azvmwaresolutionapicluster
schema: 2.0.0
---

# Update-AzVMwareSolutionApiCluster
...
```
Update-AzVMwareSolutionApiCluster -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
```
Update-AzVMwareSolutionApiCluster -InputObject <IVMwareSolutionApiIdentity> [-ClusterSize <Int32>]
