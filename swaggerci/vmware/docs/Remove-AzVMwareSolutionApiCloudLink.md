...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapicloudlink
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiCloudLink
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiCloudLink -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiCloudLink -InputObject <IVMwareSolutionApiIdentity> [-DefaultProfile <PSObject>]
