...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapicluster
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiCluster
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiCluster -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiCluster -InputObject <IVMwareSolutionApiIdentity> [-DefaultProfile <PSObject>]
