...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiworkloadnetworksegment
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiWorkloadNetworkSegment
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiWorkloadNetworkSegment -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiWorkloadNetworkSegment -InputObject <IVMwareSolutionApiIdentity>
