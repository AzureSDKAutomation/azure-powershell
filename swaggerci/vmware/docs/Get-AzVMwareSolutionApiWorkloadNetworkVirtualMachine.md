...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/get-azvmwaresolutionapiworkloadnetworkvirtualmachine
schema: 2.0.0
---

# Get-AzVMwareSolutionApiWorkloadNetworkVirtualMachine
...
### List (Default)
```
Get-AzVMwareSolutionApiWorkloadNetworkVirtualMachine -PrivateCloudName <String> -ResourceGroupName <String>
...
### GetViaIdentity
```
Get-AzVMwareSolutionApiWorkloadNetworkVirtualMachine -InputObject <IVMwareSolutionApiIdentity>
