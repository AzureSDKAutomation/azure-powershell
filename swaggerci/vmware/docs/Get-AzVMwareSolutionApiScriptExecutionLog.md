...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/get-azvmwaresolutionapiscriptexecutionlog
schema: 2.0.0
---

# Get-AzVMwareSolutionApiScriptExecutionLog
...
### Get (Default)
```
Get-AzVMwareSolutionApiScriptExecutionLog -PrivateCloudName <String> -ResourceGroupName <String>
 -ScriptExecutionName <String> -ScriptOutputStreamType <ScriptOutputStreamType[]> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareSolutionApiScriptExecutionLog -InputObject <IVMwareSolutionApiIdentity>
 -ScriptOutputStreamType <ScriptOutputStreamType[]> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.ScriptOutputStreamType[]
Parameter Sets: (All)
Aliases:
