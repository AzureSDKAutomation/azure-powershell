...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/get-azvmwaresolutionapiscriptpackage
schema: 2.0.0
---

# Get-AzVMwareSolutionApiScriptPackage
...
### List (Default)
```
Get-AzVMwareSolutionApiScriptPackage -PrivateCloudName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### Get
```
Get-AzVMwareSolutionApiScriptPackage -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareSolutionApiScriptPackage -InputObject <IVMwareSolutionApiIdentity> [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
