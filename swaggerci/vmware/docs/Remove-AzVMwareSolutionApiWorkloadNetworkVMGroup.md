...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiworkloadnetworkvmgroup
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiWorkloadNetworkVMGroup
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiWorkloadNetworkVMGroup -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiWorkloadNetworkVMGroup -InputObject <IVMwareSolutionApiIdentity>
