...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiworkloadnetworkdnsservice
schema: 2.0.0
---

# New-AzVMwareSolutionApiWorkloadNetworkDnsService
...
```
New-AzVMwareSolutionApiWorkloadNetworkDnsService -DnsServiceId <String> -PrivateCloudName <String>
