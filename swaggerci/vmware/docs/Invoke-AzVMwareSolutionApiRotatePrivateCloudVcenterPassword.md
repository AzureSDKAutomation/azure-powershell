...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/invoke-azvmwaresolutionapirotateprivatecloudvcenterpassword
schema: 2.0.0
---

# Invoke-AzVMwareSolutionApiRotatePrivateCloudVcenterPassword
...
### Rotate (Default)
```
Invoke-AzVMwareSolutionApiRotatePrivateCloudVcenterPassword -PrivateCloudName <String>
...
### RotateViaIdentity
```
Invoke-AzVMwareSolutionApiRotatePrivateCloudVcenterPassword -InputObject <IVMwareSolutionApiIdentity>
