...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiworkloadnetworksegment
schema: 2.0.0
---
...
```
New-AzVMwareSolutionApiWorkloadNetworkSegment -PrivateCloudName <String> -ResourceGroupName <String>
