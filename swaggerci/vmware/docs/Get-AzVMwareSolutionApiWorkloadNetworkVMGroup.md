...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/get-azvmwaresolutionapiworkloadnetworkvmgroup
schema: 2.0.0
---

# Get-AzVMwareSolutionApiWorkloadNetworkVMGroup
...
### List (Default)
```
Get-AzVMwareSolutionApiWorkloadNetworkVMGroup -PrivateCloudName <String> -ResourceGroupName <String>
...
```
Get-AzVMwareSolutionApiWorkloadNetworkVMGroup -PrivateCloudName <String> -ResourceGroupName <String>
 -VMGroupId <String> [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzVMwareSolutionApiWorkloadNetworkVMGroup -InputObject <IVMwareSolutionApiIdentity>
