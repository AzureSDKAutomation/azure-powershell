...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/update-azvmwaresolutionapiworkloadnetworkdhcp
schema: 2.0.0
---

# Update-AzVMwareSolutionApiWorkloadNetworkDhcp
...
```
Update-AzVMwareSolutionApiWorkloadNetworkDhcp -DhcpId <String> -PrivateCloudName <String>
 -ResourceGroupName <String> [-SubscriptionId <String>] [-DhcpType <DhcpTypeEnum>] [-DisplayName <String>]
 [-Revision <Int64>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzVMwareSolutionApiWorkloadNetworkDhcp -InputObject <IVMwareSolutionApiIdentity>
 [-DhcpType <DhcpTypeEnum>] [-DisplayName <String>] [-Revision <Int64>] [-DefaultProfile <PSObject>] [-AsJob]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.DhcpTypeEnum
Parameter Sets: (All)
Aliases:
