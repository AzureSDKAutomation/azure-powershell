...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiauthorization
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiAuthorization
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiAuthorization -Name <String> -PrivateCloudName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiAuthorization -InputObject <IVMwareSolutionApiIdentity> [-DefaultProfile <PSObject>]
