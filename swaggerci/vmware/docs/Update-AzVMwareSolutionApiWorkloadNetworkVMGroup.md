...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/update-azvmwaresolutionapiworkloadnetworkvmgroup
schema: 2.0.0
---

# Update-AzVMwareSolutionApiWorkloadNetworkVMGroup
...
```
Update-AzVMwareSolutionApiWorkloadNetworkVMGroup -PrivateCloudName <String> -ResourceGroupName <String>
...
```
Update-AzVMwareSolutionApiWorkloadNetworkVMGroup -InputObject <IVMwareSolutionApiIdentity>
 [-DisplayName <String>] [-Member <String[]>] [-Revision <Int64>] [-DefaultProfile <PSObject>] [-AsJob]
