...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/new-azvmwaresolutionapiprivatecloud
schema: 2.0.0
---

# New-AzVMwareSolutionApiPrivateCloud
...
```
New-AzVMwareSolutionApiPrivateCloud -Name <String> -ResourceGroupName <String> -SkuName <String>
 [-SubscriptionId <String>] [-IdentitySource <IIdentitySource[]>] [-Internet <InternetEnum>]
 [-Location <String>] [-ManagementClusterSize <Int32>] [-NetworkBlock <String>] [-NsxtPassword <String>]
 [-Tag <Hashtable>] [-VcenterPassword <String>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Models.Api20210601.IIdentitySource[]
Parameter Sets: (All)
Aliases:
