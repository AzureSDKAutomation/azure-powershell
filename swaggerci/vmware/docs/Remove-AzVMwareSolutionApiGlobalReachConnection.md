...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapiglobalreachconnection
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiGlobalReachConnection
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiGlobalReachConnection -Name <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiGlobalReachConnection -InputObject <IVMwareSolutionApiIdentity>
