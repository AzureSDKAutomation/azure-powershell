...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/update-azvmwaresolutionapiworkloadnetworkdnsservice
schema: 2.0.0
---

# Update-AzVMwareSolutionApiWorkloadNetworkDnsService
...
```
Update-AzVMwareSolutionApiWorkloadNetworkDnsService -DnsServiceId <String> -PrivateCloudName <String>
...
```
Update-AzVMwareSolutionApiWorkloadNetworkDnsService -InputObject <IVMwareSolutionApiIdentity>
 [-DefaultDnsZone <String>] [-DisplayName <String>] [-DnsServiceIP <String>] [-FqdnZone <String[]>]
 [-LogLevel <DnsServiceLogLevelEnum>] [-Revision <Int64>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.VMwareSolutionApi.Support.DnsServiceLogLevelEnum
Parameter Sets: (All)
Aliases:
