...
online version: https://docs.microsoft.com/en-us/powershell/module/az.vmwaresolutionapi/remove-azvmwaresolutionapihcxenterprisesite
schema: 2.0.0
---

# Remove-AzVMwareSolutionApiHcxEnterpriseSite
...
### Delete (Default)
```
Remove-AzVMwareSolutionApiHcxEnterpriseSite -Name <String> -PrivateCloudName <String>
...
### DeleteViaIdentity
```
Remove-AzVMwareSolutionApiHcxEnterpriseSite -InputObject <IVMwareSolutionApiIdentity>
