namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class Resource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IResource.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json ? new Resource(json) : null;
        }
        ...
        internal Resource(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json)
        {
            ...
            {_systemData = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject>("systemData"), out var __jsonSystemData) ? Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.SystemData.FromJson(__jsonSystemData) : SystemData;}
