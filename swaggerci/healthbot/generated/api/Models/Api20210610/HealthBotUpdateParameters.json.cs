namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class HealthBotUpdateParameters
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBotUpdateParameters.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBotUpdateParameters.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBotUpdateParameters FromJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json ? new HealthBotUpdateParameters(json) : null;
        }
        ...
        internal HealthBotUpdateParameters(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json)
        {
            ...
            {_sku = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject>("sku"), out var __jsonSku) ? Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.Sku.FromJson(__jsonSku) : Sku;}
            {_identity = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject>("identity"), out var __jsonIdentity) ? Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.Identity.FromJson(__jsonIdentity) : Identity;}
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.HealthBotUpdateParametersTags.FromJson(__jsonTags) : Tag;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="HealthBotUpdateParameters" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="HealthBotUpdateParameters" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._identity ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) this._identity.ToJson(null,serializationMode) : null, "identity" ,container.Add );
            AddIf( null != this._tag ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) this._tag.ToJson(null,serializationMode) : null, "tags" ,container.Add );
