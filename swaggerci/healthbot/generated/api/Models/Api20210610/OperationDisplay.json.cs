namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class OperationDisplay
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IOperationDisplay.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IOperationDisplay.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IOperationDisplay FromJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json ? new OperationDisplay(json) : null;
        }
        ...
        /// <summary>
        /// Serializes this instance of <see cref="OperationDisplay" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OperationDisplay" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._provider)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._provider.ToString()) : null, "provider" ,container.Add );
            AddIf( null != (((object)this._resource)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._resource.ToString()) : null, "resource" ,container.Add );
            AddIf( null != (((object)this._operation)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._operation.ToString()) : null, "operation" ,container.Add );
            AddIf( null != (((object)this._description)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._description.ToString()) : null, "description" ,container.Add );
