namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class ErrorAutoGenerated
    {
        ...
        internal ErrorAutoGenerated(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json)
        {
            ...
            {_detail = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonArray>("details"), out var __jsonDetails) ? If( __jsonDetails as Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonArray, out var __v) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IError[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__v, (__u)=>(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IError) (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.Error.FromJson(__u) )) ))() : null : Detail;}
            {_additionalInfo = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonArray>("additionalInfo"), out var __jsonAdditionalInfo) ? If( __jsonAdditionalInfo as Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonArray, out var __q) ? new global::System.Func<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IErrorAdditionalInfo[]>(()=> global::System.Linq.Enumerable.ToArray(global::System.Linq.Enumerable.Select(__q, (__p)=>(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IErrorAdditionalInfo) (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ErrorAdditionalInfo.FromJson(__p) )) ))() : null : AdditionalInfo;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IErrorAutoGenerated.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IErrorAutoGenerated.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IErrorAutoGenerated FromJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json ? new ErrorAutoGenerated(json) : null;
        }
