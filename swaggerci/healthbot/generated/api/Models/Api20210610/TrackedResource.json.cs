namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class TrackedResource
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ITrackedResource.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ITrackedResource.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ITrackedResource FromJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json ? new TrackedResource(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="TrackedResource" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TrackedResource" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._location)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._location.ToString()) : null, "location" ,container.Add );
        ...
        internal TrackedResource(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json)
        {
            ...
            __resource = new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.Resource(json);
            {_tag = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject>("tags"), out var __jsonTags) ? Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.TrackedResourceTags.FromJson(__jsonTags) : Tag;}
