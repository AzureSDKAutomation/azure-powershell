namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class BotResponseList :
        Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IBotResponseList,
        Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IBotResponseListInternal
    {

        /// <summary>Internal Acessors for NextLink</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IBotResponseListInternal.NextLink { get => this._nextLink; set { {_nextLink = value;} } }

        /// <summary>Internal Acessors for Value</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBot[] Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IBotResponseListInternal.Value { get => this._value; set { {_value = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBot[] _value;

        /// <summary>Gets the list of Azure Health Bot results and their properties.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Origin(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBot[] Value { get => this._value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBot) })]
        Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBot[] Value { get;  }
...

    {
        ...
        /// <summary>Gets the list of Azure Health Bot results and their properties.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.IHealthBot[] Value { get; set; }
