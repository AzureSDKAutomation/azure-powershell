namespace Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610
{
    ...
    public partial class SystemData
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ISystemData.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ISystemData.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Models.Api20210610.ISystemData FromJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject json ? new SystemData(json) : null;
        }
        ...
        /// <summary>
        /// Serializes this instance of <see cref="SystemData" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="SystemData" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._createdBy)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._createdBy.ToString()) : null, "createdBy" ,container.Add );
            AddIf( null != (((object)this._createdByType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._createdByType.ToString()) : null, "createdByType" ,container.Add );
            AddIf( null != this._createdAt ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._createdAt?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "createdAt" ,container.Add );
            AddIf( null != (((object)this._lastModifiedBy)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._lastModifiedBy.ToString()) : null, "lastModifiedBy" ,container.Add );
            AddIf( null != (((object)this._lastModifiedByType)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._lastModifiedByType.ToString()) : null, "lastModifiedByType" ,container.Add );
            AddIf( null != this._lastModifiedAt ? (Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.Healthbot.Runtime.Json.JsonString(this._lastModifiedAt?.ToString(@"yyyy'-'MM'-'dd'T'HH':'mm':'ss.fffffffK",global::System.Globalization.CultureInfo.InvariantCulture)) : null, "lastModifiedAt" ,container.Add );
