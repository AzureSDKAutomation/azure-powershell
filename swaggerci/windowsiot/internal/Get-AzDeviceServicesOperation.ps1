...
.Link
https://docs.microsoft.com/en-us/powershell/module/az.deviceservices/get-azdeviceservicesoperation
#>
function Get-AzDeviceServicesOperation {
[OutputType([Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IOperationEntity])]
...
begin {
    try {
        ...
        $mapping = @{
            List = 'Az.DeviceServices.private\Get-AzDeviceServicesOperation_List';
        }
