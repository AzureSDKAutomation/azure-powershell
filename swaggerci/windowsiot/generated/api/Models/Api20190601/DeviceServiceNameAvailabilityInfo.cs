namespace Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601
{
    ...
    public partial class DeviceServiceNameAvailabilityInfo :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IDeviceServiceNameAvailabilityInfoInternal
    {
        ...
        bool? Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IDeviceServiceNameAvailabilityInfoInternal.NameAvailable { get => this._nameAvailable; set { {_nameAvailable = value;} } }

        /// <summary>Internal Acessors for Reason</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Support.ServiceNameUnavailabilityReason? Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Models.Api20190601.IDeviceServiceNameAvailabilityInfoInternal.Reason { get => this._reason; set { {_reason = value;} } }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Support.ServiceNameUnavailabilityReason? _reason;

        /// <summary>The reason for unavailability.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Origin(Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Support.ServiceNameUnavailabilityReason? Reason { get => this._reason; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Support.ServiceNameUnavailabilityReason) })]
        Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Support.ServiceNameUnavailabilityReason? Reason { get;  }
...

    {
        ...
        /// <summary>The reason for unavailability.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.DeviceServices.Support.ServiceNameUnavailabilityReason? Reason { get; set; }
