...
online version: https://docs.microsoft.com/en-us/powershell/module/az.deviceservices/remove-azdeviceservicesservice
schema: 2.0.0
---

# Remove-AzDeviceServicesService
...
### Delete (Default)
```
Remove-AzDeviceServicesService -DeviceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### DeleteViaIdentity
```
Remove-AzDeviceServicesService -InputObject <IDeviceServicesIdentity> [-DefaultProfile <PSObject>] [-Confirm]
