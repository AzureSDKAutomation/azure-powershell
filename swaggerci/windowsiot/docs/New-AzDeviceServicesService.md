...
online version: https://docs.microsoft.com/en-us/powershell/module/az.deviceservices/new-azdeviceservicesservice
schema: 2.0.0
---

# New-AzDeviceServicesService
...
```
New-AzDeviceServicesService -DeviceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
