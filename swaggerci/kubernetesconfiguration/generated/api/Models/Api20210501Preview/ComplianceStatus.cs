namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20210501Preview
{
    ...
    public partial class ComplianceStatus :
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20210501Preview.IComplianceStatus,
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20210501Preview.IComplianceStatusInternal
    {

        /// <summary>Backing field for <see cref="ComplianceState" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType? _complianceState;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType? ComplianceState { get => this._complianceState; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.MessageLevelType? _messageLevel;

        /// <summary>Level of the message.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.MessageLevelType? MessageLevel { get => this._messageLevel; set => this._messageLevel = value; }

        /// <summary>Internal Acessors for ComplianceState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType? Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20210501Preview.IComplianceStatusInternal.ComplianceState { get => this._complianceState; set { {_complianceState = value;} } }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.IJsonSerializable
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType? ComplianceState { get;  }
        /// <summary>Datetime the configuration was last applied.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.MessageLevelType? MessageLevel { get; set; }
    ...
    {
        /// <summary>The compliance state of the configuration.</summary>
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Support.ComplianceStateType? ComplianceState { get; set; }
        /// <summary>Datetime the configuration was last applied.</summary>
        global::System.DateTime? LastConfigApplied { get; set; }
        /// <summary>Message from when the configuration was applied.</summary>
        string Message { get; set; }
