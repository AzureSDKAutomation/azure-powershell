namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20200701Preview
{
    ...
    /// <summary>
    /// A PowerShell PSTypeConverter to support converting to an instance of <see cref="ErrorDefinition" />
    /// </summary>
    public partial class ErrorDefinitionTypeConverter : global::System.Management.Automation.PSTypeConverter
    {
        ...
        /// parameter.
        /// </summary>
        /// <param name="sourceValue">the <see cref="System.Object" /> instance to check if it can be converted to the <see cref="ErrorDefinition"
        /// /> type.</param>
        /// <returns>
        /// <c>true</c> if the instance could be converted to a <see cref="ErrorDefinition" /> type, otherwise <c>false</c>
        /// </returns>
        ...
        /// <returns>
        /// an instance of <see cref="ErrorDefinition" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        ...
        /// /> and <see cref="ignoreCase" />
        /// </summary>
        /// <param name="sourceValue">the value to convert into an instance of <see cref="ErrorDefinition" />.</param>
        /// <returns>
        /// an instance of <see cref="ErrorDefinition" />, or <c>null</c> if there is no suitable conversion.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20200701Preview.IErrorDefinition ConvertFrom(dynamic sourceValue)
        {
            if (null == sourceValue)
            {
                return null;
            ...
            global::System.Type type = sourceValue.GetType();
            if (typeof(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.Api20200701Preview.IErrorDefinition).IsAssignableFrom(type))
            {
                return sourceValue;
            }
            try
