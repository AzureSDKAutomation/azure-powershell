...
namespace Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models
{
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Models.ISourceControlConfigurationIdentityInternal
    {
        ...
        /// <summary>Backing field for <see cref="ExtensionInstanceName" /> property.</summary>
        private string _extensionInstanceName;

        /// <summary>Name of an instance of the Extension.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Origin(Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.PropertyOrigin.Owned)]
        public string ExtensionInstanceName { get => this._extensionInstanceName; set => this._extensionInstanceName = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(string) })]
        string ExtensionInstanceName { get; set; }
        /// <summary>Resource identity path</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.SourceControlConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
