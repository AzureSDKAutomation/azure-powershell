...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kubernetesconfiguration/get-azkubernetesconfigurationsourcecontrolconfiguration
schema: 2.0.0
---

# Get-AzKubernetesConfigurationSourceControlConfiguration
...
### List (Default)
```
Get-AzKubernetesConfigurationSourceControlConfiguration -ClusterName <String> -ClusterResourceName <String>
...
### GetViaIdentity
```
Get-AzKubernetesConfigurationSourceControlConfiguration -InputObject <IKubernetesConfigurationIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
