...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kubernetesconfiguration/remove-azkubernetesconfigurationextension
schema: 2.0.0
---

# Remove-AzKubernetesConfigurationExtension
...
### Delete (Default)
```
Remove-AzKubernetesConfigurationExtension -ClusterName <String> -ClusterResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzKubernetesConfigurationExtension -InputObject <IKubernetesConfigurationIdentity>
 [-DefaultProfile <PSObject>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
