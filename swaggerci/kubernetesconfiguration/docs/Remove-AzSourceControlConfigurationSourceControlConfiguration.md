...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/remove-azsourcecontrolconfigurationsourcecontrolconfiguration
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzSourceControlConfigurationSourceControlConfiguration -ClusterName <String>
 -ClusterResourceName <String> -ClusterRp <String> -Name <String> -ResourceGroupName <String>
...
```
Remove-AzSourceControlConfigurationSourceControlConfiguration
 -InputObject <ISourceControlConfigurationIdentity> [-DefaultProfile <PSObject>] [-AsJob] [-NoWait]
