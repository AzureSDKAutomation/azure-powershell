...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kubernetesconfiguration/remove-azkubernetesconfigurationsourcecontrolconfiguration
schema: 2.0.0
---

# Remove-AzKubernetesConfigurationSourceControlConfiguration
...
### Delete (Default)
```
Remove-AzKubernetesConfigurationSourceControlConfiguration -ClusterName <String> -ClusterResourceName <String>
...
### DeleteViaIdentity
```
Remove-AzKubernetesConfigurationSourceControlConfiguration -InputObject <IKubernetesConfigurationIdentity>
 [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
