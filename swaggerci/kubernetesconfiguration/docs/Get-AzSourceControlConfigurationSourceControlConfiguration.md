...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/get-azsourcecontrolconfigurationsourcecontrolconfiguration
schema: 2.0.0
---
...
### List (Default)
```
Get-AzSourceControlConfigurationSourceControlConfiguration -ClusterName <String> -ClusterResourceName <String>
...
### GetViaIdentity
```
Get-AzSourceControlConfigurationSourceControlConfiguration -InputObject <ISourceControlConfigurationIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
