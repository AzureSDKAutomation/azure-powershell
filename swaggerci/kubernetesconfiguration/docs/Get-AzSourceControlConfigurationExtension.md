...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/get-azsourcecontrolconfigurationextension
schema: 2.0.0
---

# Get-AzSourceControlConfigurationExtension
...
### List (Default)
```
Get-AzSourceControlConfigurationExtension -ClusterName <String> -ClusterResourceName <String>
...
### GetViaIdentity
```
Get-AzSourceControlConfigurationExtension -InputObject <ISourceControlConfigurationIdentity>
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```
