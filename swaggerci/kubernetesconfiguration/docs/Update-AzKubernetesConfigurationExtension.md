...
online version: https://docs.microsoft.com/en-us/powershell/module/az.kubernetesconfiguration/update-azkubernetesconfigurationextension
schema: 2.0.0
---
...
```
Update-AzKubernetesConfigurationExtension -ClusterName <String> -ClusterResourceName <String>
...
```
Update-AzKubernetesConfigurationExtension -InputObject <IKubernetesConfigurationIdentity>
 [-AutoUpgradeMinorVersion] [-ReleaseTrain <String>] [-Version <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
