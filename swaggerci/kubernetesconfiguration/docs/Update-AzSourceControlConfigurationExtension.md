...
online version: https://docs.microsoft.com/en-us/powershell/module/az.sourcecontrolconfiguration/update-azsourcecontrolconfigurationextension
schema: 2.0.0
---
...
```
Update-AzSourceControlConfigurationExtension -ClusterName <String> -ClusterResourceName <String>
 -ClusterRp <String> -InstanceName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-AutoUpgradeMinorVersion] [-ReleaseTrain <String>] [-Version <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzSourceControlConfigurationExtension -InputObject <ISourceControlConfigurationIdentity>
 [-AutoUpgradeMinorVersion] [-ReleaseTrain <String>] [-Version <String>] [-DefaultProfile <PSObject>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```
