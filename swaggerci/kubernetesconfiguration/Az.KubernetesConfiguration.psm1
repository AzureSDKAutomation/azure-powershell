# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.KubernetesConfiguration.private.dll')

  # Get the private module's instance
  $instance = [Microsoft.Azure.PowerShell.Cmdlets.KubernetesConfiguration.Module]::Instance
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.KubernetesConfiguration.custom.psm1'
