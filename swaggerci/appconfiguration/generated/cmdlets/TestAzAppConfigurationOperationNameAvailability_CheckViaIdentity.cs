...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzAppConfigurationOperationNameAvailability_CheckViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class TestAzAppConfigurationOperationNameAvailability_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="CheckNameAvailabilityParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.ICheckNameAvailabilityParameters _checkNameAvailabilityParameter;

        /// <summary>Parameters used for checking whether a resource name is available.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Parameters used for checking whether a resource name is available.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Parameters used for checking whether a resource name is available.",
        SerializedName = @"checkNameAvailabilityParameters",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.ICheckNameAvailabilityParameters) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.ICheckNameAvailabilityParameters CheckNameAvailabilityParameter { get => this._checkNameAvailabilityParameter; set => this._checkNameAvailabilityParameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.OperationsCheckNameAvailabilityViaIdentity(InputObject.Id, CheckNameAvailabilityParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.OperationsCheckNameAvailability(InputObject.SubscriptionId ?? null, CheckNameAvailabilityParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=CheckNameAvailabilityParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzAppConfigurationOperationNameAvailability_CheckViaIdentity" /> cmdlet
        /// class.
        /// </summary>
        public TestAzAppConfigurationOperationNameAvailability_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CheckNameAvailabilityParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=CheckNameAvailabilityParameter })
                    {
