...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    /// </summary>
    /// <remarks>
    /// [OpenAPI] CreateOrUpdate=>PUT:"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.AppConfiguration/configurationStores/{configStoreName}/privateEndpointConnections/{privateEndpointConnectionName}"
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAppConfigurationPrivateEndpointConnection_CreateExpanded", SupportsShouldProcess = true)]
    [global::System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection))]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"Update the state of the specified private endpoint connection associated with the configuration store.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Generated]
    public partial class NewAzAppConfigurationPrivateEndpointConnection_CreateExpanded : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Private endpoint connection name")]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = true,
        ReadOnly = false,
        ...
        /// <summary>Backing field for <see cref="PrivateEndpointConnectionBody" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection _privateEndpointConnectionBody= new Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.PrivateEndpointConnection();

        /// <summary>A private endpoint connection</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection PrivateEndpointConnectionBody { get => this._privateEndpointConnectionBody; set => this._privateEndpointConnectionBody = value; }

        /// <summary>The resource Id for private endpoint</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The resource Id for private endpoint")]
        ...
        SerializedName = @"id",
        PossibleTypes = new [] { typeof(string) })]
        public string PrivateEndpointId { get => PrivateEndpointConnectionBody.PrivateEndpointId ?? null; set => PrivateEndpointConnectionBody.PrivateEndpointId = value; }

        /// <summary>The private link service connection description.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The private link service connection description.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        PossibleTypes = new [] { typeof(string) })]
        public string PrivateLinkServiceConnectionStateDescription { get => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateDescription ?? null; set => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateDescription = value; }

        /// <summary>The private link service connection status.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = false, HelpMessage = "The private link service connection status.")]
        [global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Category(global::Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.ParameterCategory.Body)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Info(
        Required = false,
        ReadOnly = false,
        ...
        [global::System.Management.Automation.ArgumentCompleter(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.ConnectionStatus))]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.ConnectionStatus PrivateLinkServiceConnectionStateStatus { get => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateStatus ?? ((Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Support.ConnectionStatus)""); set => PrivateEndpointConnectionBody.PrivateLinkServiceConnectionStateStatus = value; }
        ...
        /// </summary>
        /// <param name="responseMessage">the raw response message as an global::System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection"
        /// /> from the remote call</param>
        /// <param name="returnNow">/// Determines if the rest of the onOk method should be processed, or if the method should return
        /// immediately (set to true to skip further processing )</param>

        partial void overrideOnOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection> response, ref global::System.Threading.Tasks.Task<bool> returnNow);
        ...
        /// <returns>
        /// a duplicate instance of NewAzAppConfigurationPrivateEndpointConnection_CreateExpanded
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.NewAzAppConfigurationPrivateEndpointConnection_CreateExpanded Clone()
        {
            var clone = new NewAzAppConfigurationPrivateEndpointConnection_CreateExpanded();
            ...
            clone.PrivateEndpointConnectionBody = this.PrivateEndpointConnectionBody;
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAppConfigurationPrivateEndpointConnection_CreateExpanded" /> cmdlet class.
        /// </summary>
        public NewAzAppConfigurationPrivateEndpointConnection_CreateExpanded()
        {
        ...
        protected override void ProcessRecord()
        {
            ...
            {
                // work
                if (ShouldProcess($"Call remote 'PrivateEndpointConnectionsCreateOrUpdate' operation"))
                {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.PrivateEndpointConnectionsCreateOrUpdate(SubscriptionId, ResourceGroupName, ConfigStoreName, Name, PrivateEndpointConnectionBody, onOk, onDefault, this, Pipeline);
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  SubscriptionId=SubscriptionId,ResourceGroupName=ResourceGroupName,ConfigStoreName=ConfigStoreName,Name=Name,body=PrivateEndpointConnectionBody})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IErrorResponse> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId=SubscriptionId, ResourceGroupName=ResourceGroupName, ConfigStoreName=ConfigStoreName, Name=Name, body=PrivateEndpointConnectionBody })
                    {
        ...
        /// A <see cref="global::System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async global::System.Threading.Tasks.Task onOk(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection> response)
        {
            using( NoSynchronizationContext )
            {
                var _returnNow = global::System.Threading.Tasks.Task<bool>.FromResult(false);
                ...
                // (await response) // should be Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.Api20210301Preview.IPrivateEndpointConnection
