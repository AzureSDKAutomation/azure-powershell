namespace Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101
{
    ...
    public partial class ReturnShipping
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IReturnShipping.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IReturnShipping.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IReturnShipping FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject json ? new ReturnShipping(json) : null;
        }

        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject into a new instance of <see cref="ReturnShipping" />.
        /// </summary>
        ...
        internal ReturnShipping(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject json)
        {
            ...
            {_carrierAccountNumber = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonString>("carrierAccountNumber"), out var __jsonCarrierAccountNumber) ? (string)__jsonCarrierAccountNumber : (string)CarrierAccountNumber;}
            AfterFromJson(json);
        }

        /// <summary>
        /// Serializes this instance of <see cref="ReturnShipping" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ReturnShipping" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != (((object)this._carrierAccountNumber)?.ToString()) ? (Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode) new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonString(this._carrierAccountNumber.ToString()) : null, "carrierAccountNumber" ,container.Add );
