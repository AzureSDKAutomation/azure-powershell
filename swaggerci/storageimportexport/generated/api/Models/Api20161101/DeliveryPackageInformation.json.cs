namespace Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101
{
    ...
    public partial class DeliveryPackageInformation
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject into a new instance of <see cref="DeliveryPackageInformation" />.
        /// </summary>
        ...
        internal DeliveryPackageInformation(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject json)
        {
            ...
            {_driveCount = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNumber>("driveCount"), out var __jsonDriveCount) ? (long?)__jsonDriveCount : DriveCount;}
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IDeliveryPackageInformation.
        /// </summary>
        ...
        /// <returns>
        /// an instance of Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IDeliveryPackageInformation.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IDeliveryPackageInformation FromJson(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject json ? new DeliveryPackageInformation(json) : null;
        }

        /// <summary>
        /// Serializes this instance of <see cref="DeliveryPackageInformation" /> into a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="DeliveryPackageInformation" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != this._driveCount ? (Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNode)new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Json.JsonNumber((long)this._driveCount) : null, "driveCount" ,container.Add );
