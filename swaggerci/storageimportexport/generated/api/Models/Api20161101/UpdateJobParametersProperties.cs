namespace Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101
{
    ...
    public partial class UpdateJobParametersProperties :
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IUpdateJobParametersProperties,
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IUpdateJobParametersPropertiesInternal
    {
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IDeliveryPackageInformation Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IUpdateJobParametersPropertiesInternal.DeliveryPackage { get => (this._deliveryPackage = this._deliveryPackage ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.DeliveryPackageInformation()); set { {_deliveryPackage = value;} } }

        /// <summary>Internal Acessors for ReturnAddress</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IReturnAddress Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IUpdateJobParametersPropertiesInternal.ReturnAddress { get => (this._returnAddress = this._returnAddress ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.ReturnAddress()); set { {_returnAddress = value;} } }

        /// <summary>Internal Acessors for ReturnShipping</summary>
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IReturnShipping Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IUpdateJobParametersPropertiesInternal.ReturnShipping { get => (this._returnShipping = this._returnShipping ?? new Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.ReturnShipping()); set { {_returnShipping = value;} } }
