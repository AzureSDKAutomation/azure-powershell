namespace Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101
{
    ...
    public partial class DriveStatus :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models.Api20161101.IDriveStatusInternal
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Support.DriveState? _state;

        /// <summary>The drive's current state.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Origin(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Support.DriveState? State { get => this._state; set => this._state = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Support.DriveState) })]
        Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Support.DriveState? State { get; set; }
        /// <summary>
        /// A URI that points to the blob containing the verbose log for the data transfer operation.
        /// </summary>
        [Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.Info(
