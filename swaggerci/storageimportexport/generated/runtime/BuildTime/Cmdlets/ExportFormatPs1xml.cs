...
namespace Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Runtime.PowerShell
{
  ...
  public class ExportFormatPs1xml : PSCmdlet
  {
    ...
    private const string ModelNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Models";
    private const string SupportNamespace = @"Microsoft.Azure.PowerShell.Cmdlets.StorageImportExport.Support";
