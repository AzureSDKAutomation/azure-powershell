...
```
New-AzStorageImportExportJob -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 ...
 [-PercentComplete <Int32>] [-ProvisioningState <String>] [-ReturnAddressCity <String>]
