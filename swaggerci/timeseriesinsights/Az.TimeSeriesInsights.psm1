# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.TimeSeriesInsights.private.dll')
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.TimeSeriesInsights.custom.psm1'
