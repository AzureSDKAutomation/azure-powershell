...
```
Update-AzTimeSeriesInsightsEnvironment -Name <String> -ResourceGroupName <String> -Kind <EnvironmentKind>
...
```
Update-AzTimeSeriesInsightsEnvironment -InputObject <ITimeSeriesInsightsIdentity> -Kind <EnvironmentKind>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.TimeSeriesInsights.Support.EnvironmentKind
Parameter Sets: (All)
Aliases:
