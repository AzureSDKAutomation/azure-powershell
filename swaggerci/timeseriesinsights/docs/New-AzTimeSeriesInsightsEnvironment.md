...
```
New-AzTimeSeriesInsightsEnvironment -Name <String> -ResourceGroupName <String> -Kind <EnvironmentKind>
 -Location <String> -SkuCapacity <Int32> -SkuName <SkuName> [-SubscriptionId <String>] [-Tag <Hashtable>]
