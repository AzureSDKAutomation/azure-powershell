...
online version: https://docs.microsoft.com/en-us/powershell/module/az.hybridcompute/update-azhybridcomputeextension
schema: 2.0.0
---

# Update-AzHybridComputeExtension
...
```
Update-AzHybridComputeExtension -MachineName <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-ExtensionTarget <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Upgrade
```
Update-AzHybridComputeExtension -MachineName <String> -ResourceGroupName <String>
...
### UpgradeViaIdentity
```
Update-AzHybridComputeExtension -InputObject <IHybridComputeIdentity>
...
```
Update-AzHybridComputeExtension -InputObject <IHybridComputeIdentity> [-ExtensionTarget <Hashtable>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210610Preview.IMachineExtensionUpgrade
