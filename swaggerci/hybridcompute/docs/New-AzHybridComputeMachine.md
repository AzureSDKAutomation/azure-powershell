...
New-AzHybridComputeMachine -Name <String> -ResourceGroupName <String> -Location <String>
 ...
 [-PrivateLinkScopeResourceId <String>] [-Tag <Hashtable>] [-VMId <String>] [-DefaultProfile <PSObject>]
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210325Preview.IMachineExtensionInstanceView[]
Parameter Sets: (All)
Aliases:
