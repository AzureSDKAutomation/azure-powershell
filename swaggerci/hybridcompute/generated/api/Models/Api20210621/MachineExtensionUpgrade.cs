namespace Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621
{
    ...
    public partial class MachineExtensionUpgrade :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621.IMachineExtensionUpgradeInternal
    {

        /// <summary>Backing field for <see cref="ExtensionTarget" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621.IExtensionTarget _extensionTarget;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621.IExtensionTarget ExtensionTarget { get => (this._extensionTarget = this._extensionTarget ?? new Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621.ExtensionTarget()); set => this._extensionTarget = value; }
        ...
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Runtime.IJsonSerializable
    {
        ...
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621.IExtensionTarget) })]
        Microsoft.Azure.PowerShell.Cmdlets.HybridCompute.Models.Api20210621.IExtensionTarget ExtensionTarget { get; set; }
