# region Generated 
  ...
  $null = Import-Module -Name (Join-Path $PSScriptRoot './bin/Az.Operations.private.dll')

  # Get the private module's instance
  $instance = [Microsoft.Azure.PowerShell.Cmdlets.Operations.Module]::Instance
  ...
  $customModulePath = Join-Path $PSScriptRoot './custom/Az.Operations.custom.psm1'
