namespace Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.Api20151101Preview
{
    ...
    public partial class ManagementConfigurationProperties :
        ...
        Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.Api20151101Preview.IManagementConfigurationPropertiesInternal
    {
        ...
        string Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.Api20151101Preview.IManagementConfigurationPropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Backing field for <see cref="Parameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.Api20151101Preview.IArmTemplateParameter[] _parameter;

        /// <summary>Parameters to run the ARM template</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Operations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Operations.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.Api20151101Preview.IArmTemplateParameter[] Parameter { get => this._parameter; set => this._parameter = value; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.IAny _template;

        /// <summary>The Json object containing the ARM template to deploy</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.Operations.Origin(Microsoft.Azure.PowerShell.Cmdlets.Operations.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.IAny Template { get => (this._template = this._template ?? new Microsoft.Azure.PowerShell.Cmdlets.Operations.Models.Any()); set => this._template = value; }
