...
using Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.Json;
using System;
...
namespace Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime
{
    ...
    internal static class JsonSerializable
    {
        ...
        internal static JsonNode ToJsonValue(object value)
        {
            ...
            if (value is Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.IJsonSerializable jsonSerializable)
            {
            ...
            {
                return Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.JsonSerializable.ToJson(dictionary, null);
            }
