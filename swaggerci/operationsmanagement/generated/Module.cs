...
namespace Microsoft.Azure.PowerShell.Cmdlets.Operations
{
    ...
    public partial class Module
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline _pipeline;

        /// <summary>the ISendAsync pipeline instance (when proxy is enabled)</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline _pipelineWithProxy;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.Operations.OperationsManagementClient ClientAPI { get; set; }
        ...
        private static Microsoft.Azure.PowerShell.Cmdlets.Operations.Module _instance;

        /// <summary>the singleton of this module class</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.Operations.Module Instance => Microsoft.Azure.PowerShell.Cmdlets.Operations.Module._instance?? (Microsoft.Azure.PowerShell.Cmdlets.Operations.Module._instance = new Microsoft.Azure.PowerShell.Cmdlets.Operations.Module());

        /// <summary>The Name of this module</summary>
        public string Name => @"Az.Operations";
        ...
        public string ResourceId => @"Az.Operations";

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void AfterCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline pipeline);

        /// <param name="invocationInfo">The <see cref="System.Management.Automation.InvocationInfo" /> from the cmdlet</param>
        /// <param name="pipeline">The HttpPipeline for the request</param>

        partial void BeforeCreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, ref Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline pipeline);
        ...
        /// <returns>An instance of Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline for the remote call.</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline CreatePipeline(global::System.Management.Automation.InvocationInfo invocationInfo, string correlationId, string processRecordId, string parameterSetName = null)
        {
            Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline pipeline = null;
        ...
        {
            /// constructor
            ClientAPI = new Microsoft.Azure.PowerShell.Cmdlets.Operations.OperationsManagementClient();
            _handler.Proxy = _webProxy;
            _pipeline = new Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient()));
            _pipelineWithProxy = new Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpPipeline(new Microsoft.Azure.PowerShell.Cmdlets.Operations.Runtime.HttpClientFactory(new global::System.Net.Http.HttpClient(_handler)));
        }
