...
online version: https://docs.microsoft.com/en-us/powershell/module/az.operations/remove-azoperationsmanagementassociation
schema: 2.0.0
---

# Remove-AzOperationsManagementAssociation
...
### Delete (Default)
```
Remove-AzOperationsManagementAssociation -Name <String> -ProviderName <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzOperationsManagementAssociation -InputObject <IOperationsIdentity> [-DefaultProfile <PSObject>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
