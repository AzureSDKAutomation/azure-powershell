...
online version: https://docs.microsoft.com/en-us/powershell/module/az.operations/update-azoperationssolution
schema: 2.0.0
---

# Update-AzOperationsSolution
...
```
Update-AzOperationsSolution -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
 [-Tag <Hashtable>] [-DefaultProfile <PSObject>] [-AsJob] [-NoWait] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Update-AzOperationsSolution -InputObject <IOperationsIdentity> [-Tag <Hashtable>] [-DefaultProfile <PSObject>]
