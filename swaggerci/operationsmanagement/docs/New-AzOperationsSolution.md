...
online version: https://docs.microsoft.com/en-us/powershell/module/az.operations/new-azoperationssolution
schema: 2.0.0
---

# New-AzOperationsSolution
...
```
New-AzOperationsSolution -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
