namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20210601Preview
{
    ...
    public partial class UserSourceInfo
    {
        ...
        /// Note: the Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20210601Preview.IUserSourceInfo interface is polymorphic,
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20210601Preview.IUserSourceInfo FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Json.JsonNode node)
        {
            ...
            switch ( json.StringProperty("type") )
            {
                ...
                case "BuildResult":
                {
                    return new BuildResultUserSourceInfo(json);
                }
                case "Container":
                {
                    return new CustomContainer(json);
                }
            }
            return new UserSourceInfo(json);
        }
