namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview
{
    ...
    public partial class AppResourceProperties :
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourceProperties,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal
    {
        ...
        global::System.DateTime? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal.CreatedTime { get => this._createdTime; set { {_createdTime = value;} } }

        /// <summary>Internal Acessors for PersistentDisk</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDisk Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal.PersistentDisk { get => (this._persistentDisk = this._persistentDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.PersistentDisk()); set { {_persistentDisk = value;} } }

        /// <summary>Internal Acessors for PersistentDiskUsedInGb</summary>
        int? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal.PersistentDiskUsedInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).UsedInGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).UsedInGb = value; }

        /// <summary>Internal Acessors for ProvisioningState</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Support.AppResourceProvisioningState? Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal.ProvisioningState { get => this._provisioningState; set { {_provisioningState = value;} } }

        /// <summary>Internal Acessors for TemporaryDisk</summary>
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDisk Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal.TemporaryDisk { get => (this._temporaryDisk = this._temporaryDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.TemporaryDisk()); set { {_temporaryDisk = value;} } }

        /// <summary>Internal Acessors for Url</summary>
        string Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IAppResourcePropertiesInternal.Url { get => this._url; set { {_url = value;} } }

        /// <summary>Backing field for <see cref="PersistentDisk" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDisk _persistentDisk;

        /// <summary>Persistent disk settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDisk PersistentDisk { get => (this._persistentDisk = this._persistentDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.PersistentDisk()); set => this._persistentDisk = value; }
        ...
        public string PersistentDiskMountPath { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).MountPath; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).MountPath = value ?? null; }

        /// <summary>Size of the persistent disk in GB</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public int? PersistentDiskSizeInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).SizeInGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).SizeInGb = value ?? default(int); }

        /// <summary>Size of the used persistent disk in GB</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public int? PersistentDiskUsedInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IPersistentDiskInternal)PersistentDisk).UsedInGb; }
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDisk _temporaryDisk;

        /// <summary>Temporary disk settings</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Owned)]
        internal Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDisk TemporaryDisk { get => (this._temporaryDisk = this._temporaryDisk ?? new Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.TemporaryDisk()); set => this._temporaryDisk = value; }

        /// <summary>Mount path of the temporary disk</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public string TemporaryDiskMountPath { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDiskInternal)TemporaryDisk).MountPath; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDiskInternal)TemporaryDisk).MountPath = value ?? null; }

        /// <summary>Size of the temporary disk in GB</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Origin(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.PropertyOrigin.Inlined)]
        public int? TemporaryDiskSizeInGb { get => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDiskInternal)TemporaryDisk).SizeInGb; set => ((Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ITemporaryDiskInternal)TemporaryDisk).SizeInGb = value ?? default(int); }
