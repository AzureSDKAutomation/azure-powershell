...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzAppPlatformServiceVnetRoleAssignment_CheckViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class TestAzAppPlatformServiceVnetRoleAssignment_CheckViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="RoleAssignmentParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IVnetRoleAssignmentParameter _roleAssignmentParameter;

        /// <summary>Vnet Role Assignment parameters payload</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Vnet Role Assignment parameters payload", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Vnet Role Assignment parameters payload",
        SerializedName = @"roleAssignmentParameter",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IVnetRoleAssignmentParameter) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IVnetRoleAssignmentParameter RoleAssignmentParameter { get => this._roleAssignmentParameter; set => this._roleAssignmentParameter = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesCheckVnetRoleAssignmentViaIdentity(InputObject.Id, RoleAssignmentParameter, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesCheckVnetRoleAssignment(InputObject.SubscriptionId ?? null, RoleAssignmentParameter, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RoleAssignmentParameter})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzAppPlatformServiceVnetRoleAssignment_CheckViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzAppPlatformServiceVnetRoleAssignment_CheckViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RoleAssignmentParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RoleAssignmentParameter })
                    {
