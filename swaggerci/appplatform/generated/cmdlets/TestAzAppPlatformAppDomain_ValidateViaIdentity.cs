...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsDiagnostic.Test, @"AzAppPlatformAppDomain_ValidateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class TestAzAppPlatformAppDomain_ValidateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ValidatePayload" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ICustomDomainValidatePayload _validatePayload;

        /// <summary>Custom domain validate payload.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Custom domain validate payload.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Custom domain validate payload.",
        SerializedName = @"validatePayload",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ICustomDomainValidatePayload) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ICustomDomainValidatePayload ValidatePayload { get => this._validatePayload; set => this._validatePayload = value; }
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.AppsValidateDomainViaIdentity(InputObject.Id, ValidatePayload, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.AppsValidateDomain(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, InputObject.AppName ?? null, ValidatePayload, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=ValidatePayload})
                    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzAppPlatformAppDomain_ValidateViaIdentity" /> cmdlet class.
        /// </summary>
        public TestAzAppPlatformAppDomain_ValidateViaIdentity()
        {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ValidatePayload })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=ValidatePayload })
                    {
