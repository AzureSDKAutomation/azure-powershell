...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAppPlatformDeployment_List")]
    ...
    public partial class GetAzAppPlatformDeployment_List : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAppPlatformDeployment_List" /> cmdlet class.
        /// </summary>
        public GetAzAppPlatformDeployment_List()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.DeploymentsList(SubscriptionId, ResourceGroupName, ServiceName, AppName, this.InvocationInformation.BoundParameters.ContainsKey("Version") ? Version : null /* arrayOf */, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.DeploymentsList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
