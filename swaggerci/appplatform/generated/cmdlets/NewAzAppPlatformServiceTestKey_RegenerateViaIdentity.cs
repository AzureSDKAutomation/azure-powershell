...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.New, @"AzAppPlatformServiceTestKey_RegenerateViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class NewAzAppPlatformServiceTestKey_RegenerateViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="RegenerateTestKeyRequest" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IRegenerateTestKeyRequestPayload _regenerateTestKeyRequest;

        /// <summary>Regenerate test key request payload</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Regenerate test key request payload", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Regenerate test key request payload",
        SerializedName = @"regenerateTestKeyRequest",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IRegenerateTestKeyRequestPayload) })]
        public Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.IRegenerateTestKeyRequestPayload RegenerateTestKeyRequest { get => this._regenerateTestKeyRequest; set => this._regenerateTestKeyRequest = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzAppPlatformServiceTestKey_RegenerateViaIdentity" /> cmdlet class.
        /// </summary>
        public NewAzAppPlatformServiceTestKey_RegenerateViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.ServicesRegenerateTestKeyViaIdentity(InputObject.Id, RegenerateTestKeyRequest, onOk, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.ServicesRegenerateTestKey(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.ServiceName ?? null, RegenerateTestKeyRequest, onOk, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=RegenerateTestKeyRequest})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api202103Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RegenerateTestKeyRequest })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=RegenerateTestKeyRequest })
                    {
