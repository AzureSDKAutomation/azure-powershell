...
namespace Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsCommon.Get, @"AzAppPlatformService_List1")]
    ...
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Description(@"Handles requests to list all resources in a resource group.")]
    [global::Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Generated]
    public partial class GetAzAppPlatformService_List1 : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Runtime.IEventListener
    {
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzAppPlatformService_List1" /> cmdlet class.
        /// </summary>
        public GetAzAppPlatformService_List1()
        {
            ...
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    foreach( var SubscriptionId in this.SubscriptionId )
                    {
                        ...
                        await this.Client.ServicesList(SubscriptionId, ResourceGroupName, onOk, onDefault, this, Pipeline);
            ...
            using( NoSynchronizationContext )
            {
                ...
                if (result.NextLink != null)
                {
                    if (responseMessage.RequestMessage is System.Net.Http.HttpRequestMessage requestMessage )
                    {
                        ...
                        await this.Client.ServicesList_Call(requestMessage, onOk, onDefault, this, Pipeline);
                    }
                }
            }
        }
