...
### Get (Default)
```
Get-AzAppPlatformAppResourceUploadUrl -AppName <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzAppPlatformAppResourceUploadUrl -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
