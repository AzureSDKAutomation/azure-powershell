...
```
Update-AzAppPlatformApp -InputObject <IAppPlatformIdentity> [-AddonConfig <Hashtable>] [-EnableEndToEndTl]
 [-Fqdn <String>] [-HttpsOnly] [-IdentityPrincipalId <String>] [-IdentityTenantId <String>]
 [-IdentityType <ManagedIdentityType>] [-Location <String>] [-PersistentDiskMountPath <String>]
