...
Update-AzAppPlatformApp -Name <String> -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-ActiveDeploymentName <String>] [-EnableEndToEndTl] [-Fqdn <String>] [-HttpsOnly]
...
```
Update-AzAppPlatformApp -InputObject <IAppPlatformIdentity> [-ActiveDeploymentName <String>]
 [-EnableEndToEndTl] [-Fqdn <String>] [-HttpsOnly] [-IdentityPrincipalId <String>]
 [-IdentityTenantId <String>] [-IdentityType <ManagedIdentityType>] [-Location <String>]
