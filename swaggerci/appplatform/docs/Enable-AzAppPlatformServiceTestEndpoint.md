...
### Enable (Default)
```
Enable-AzAppPlatformServiceTestEndpoint -ResourceGroupName <String> -ServiceName <String>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### EnableViaIdentity
```
Enable-AzAppPlatformServiceTestEndpoint -InputObject <IAppPlatformIdentity> [-DefaultProfile <PSObject>]
