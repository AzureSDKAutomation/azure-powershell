...
online version: https://docs.microsoft.com/en-us/powershell/module/az.appplatform/test-azappplatformservicevnetroleassignment
schema: 2.0.0
---

# Test-AzAppPlatformServiceVnetRoleAssignment
...
```
Test-AzAppPlatformServiceVnetRoleAssignment -Scope <String> [-SubscriptionId <String>]
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Check
```
Test-AzAppPlatformServiceVnetRoleAssignment -RoleAssignmentParameter <IVnetRoleAssignmentParameter>
 [-SubscriptionId <String>] [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### CheckViaIdentity
```
Test-AzAppPlatformServiceVnetRoleAssignment -InputObject <IAppPlatformIdentity>
 -RoleAssignmentParameter <IVnetRoleAssignmentParameter> [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### CheckViaIdentityExpanded
```
Test-AzAppPlatformServiceVnetRoleAssignment -InputObject <IAppPlatformIdentity> -Scope <String>
 [-DefaultProfile <PSObject>] [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.AppPlatform.Models.Api20201101Preview.IVnetRoleAssignmentParameter
