...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapihostpool
schema: 2.0.0
---

# Remove-AzDesktopVirtualizationApiHostPool
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiHostPool -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiHostPool -InputObject <IDesktopVirtualizationApiIdentity> [-Force]
