...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapisessionhost
schema: 2.0.0
---

# Remove-AzDesktopVirtualizationApiSessionHost
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiSessionHost -HostPoolName <String> -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiSessionHost -InputObject <IDesktopVirtualizationApiIdentity> [-Force]
