...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/new-azdesktopvirtualizationapiworkspace
schema: 2.0.0
---
...
```
New-AzDesktopVirtualizationApiWorkspace -Name <String> -ResourceGroupName <String> [-SubscriptionId <String>]
