...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapimsixpackage
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiMsixPackage -FullName <String> -HostPoolName <String>
