...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/new-azdesktopvirtualizationapiapplicationgroup
schema: 2.0.0
---

# New-AzDesktopVirtualizationApiApplicationGroup
...
```
New-AzDesktopVirtualizationApiApplicationGroup -Name <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.ApplicationGroupType
Parameter Sets: (All)
Aliases:
