...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapisessionhostconfiguration
schema: 2.0.0
---

# Get-AzDesktopVirtualizationApiSessionHostConfiguration
...
### Get (Default)
```
Get-AzDesktopVirtualizationApiSessionHostConfiguration -HostPoolName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDesktopVirtualizationApiSessionHostConfiguration -InputObject <IDesktopVirtualizationApiIdentity>
