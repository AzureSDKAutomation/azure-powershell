...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapiscalingplan
schema: 2.0.0
---
...
### List1 (Default)
```
Get-AzDesktopVirtualizationApiScalingPlan [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>]
 [<CommonParameters>]
```
