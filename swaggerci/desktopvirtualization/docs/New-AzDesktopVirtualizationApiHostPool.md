...
New-AzDesktopVirtualizationApiHostPool -Name <String> -ResourceGroupName <String> -HostPoolType <HostPoolType>
 ...
 [-NewProperty <String>] [-PersonalDesktopAssignmentType <PersonalDesktopAssignmentType>] [-PlanName <String>]
 ...
 [-SkuTier <SkuTier>] [-SsoadfsAuthority <String>] [-SsoClientId <String>]
