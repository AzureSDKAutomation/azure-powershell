...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapiprivateendpointconnection
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiPrivateEndpointConnection -HostPoolName <String> -Name <String>
...
### Delete1
```
Remove-AzDesktopVirtualizationApiPrivateEndpointConnection -Name <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiPrivateEndpointConnection -InputObject <IDesktopVirtualizationApiIdentity>
