...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/update-azdesktopvirtualizationapiapplication
schema: 2.0.0
---
...
```
Update-AzDesktopVirtualizationApiApplication -GroupName <String> -Name <String> -ResourceGroupName <String>
...
```
Update-AzDesktopVirtualizationApiApplication -InputObject <IDesktopVirtualizationApiIdentity>
