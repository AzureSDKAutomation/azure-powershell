...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/get-azdesktopvirtualizationapiupdatedetail
schema: 2.0.0
---

# Get-AzDesktopVirtualizationApiUpdateDetail
...
### Get (Default)
```
Get-AzDesktopVirtualizationApiUpdateDetail -HostPoolName <String> -ResourceGroupName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### GetViaIdentity
```
Get-AzDesktopVirtualizationApiUpdateDetail -InputObject <IDesktopVirtualizationApiIdentity>
