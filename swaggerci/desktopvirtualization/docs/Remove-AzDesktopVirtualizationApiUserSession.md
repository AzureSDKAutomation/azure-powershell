...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/remove-azdesktopvirtualizationapiusersession
schema: 2.0.0
---
...
### Delete (Default)
```
Remove-AzDesktopVirtualizationApiUserSession -HostPoolName <String> -Id <String> -ResourceGroupName <String>
...
### DeleteViaIdentity
```
Remove-AzDesktopVirtualizationApiUserSession -InputObject <IDesktopVirtualizationApiIdentity> [-Force]
