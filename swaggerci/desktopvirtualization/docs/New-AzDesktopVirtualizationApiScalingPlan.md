...
online version: https://docs.microsoft.com/en-us/powershell/module/az.desktopvirtualizationapi/new-azdesktopvirtualizationapiscalingplan
schema: 2.0.0
---

# New-AzDesktopVirtualizationApiScalingPlan
...
```
New-AzDesktopVirtualizationApiScalingPlan -Name <String> -ResourceGroupName <String>
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210513Preview.IScalingHostPoolReference[]
Parameter Sets: (All)
Aliases:
...
```yaml
Type: Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210513Preview.IScalingSchedule[]
Parameter Sets: (All)
Aliases:
