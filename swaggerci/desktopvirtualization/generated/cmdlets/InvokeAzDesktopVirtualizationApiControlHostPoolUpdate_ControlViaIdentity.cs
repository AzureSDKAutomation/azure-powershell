...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Cmdlets
{
    ...
    /// </remarks>
    [global::System.Management.Automation.Cmdlet(global::System.Management.Automation.VerbsLifecycle.Invoke, @"AzDesktopVirtualizationApiControlHostPoolUpdate_ControlViaIdentity", SupportsShouldProcess = true)]
    ...
    public partial class InvokeAzDesktopVirtualizationApiControlHostPoolUpdate_ControlViaIdentity : global::System.Management.Automation.PSCmdlet,
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="HostPoolControlParameter" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210513Preview.IHostPoolControlParameter _hostPoolControlParameter;

        /// <summary>Represents properties for a hostpool update.</summary>
        [global::System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "Represents properties for a hostpool update.", ValueFromPipeline = true)]
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Runtime.Info(
        Required = true,
        ReadOnly = false,
        Description = @"Represents properties for a hostpool update.",
        SerializedName = @"hostPoolControlParameter",
        PossibleTypes = new [] { typeof(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210513Preview.IHostPoolControlParameter) })]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210513Preview.IHostPoolControlParameter HostPoolControlParameter { get => this._hostPoolControlParameter; set => this._hostPoolControlParameter = value; }
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="InvokeAzDesktopVirtualizationApiControlHostPoolUpdate_ControlViaIdentity"
        /// /> cmdlet class.
        /// </summary>
        public InvokeAzDesktopVirtualizationApiControlHostPoolUpdate_ControlViaIdentity()
        {
        ...
        protected async global::System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    {
                        await this.Client.HostPoolsControlUpdateViaIdentity(InputObject.Id, HostPoolControlParameter, onNoContent, onDefault, this, Pipeline);
                    }
                    else
                    {
                        ...
                        await this.Client.HostPoolsControlUpdate(InputObject.SubscriptionId ?? null, InputObject.ResourceGroupName ?? null, InputObject.HostPoolName ?? null, HostPoolControlParameter, onNoContent, onDefault, this, Pipeline);
                    }
                ...
                {
                    WriteError(new global::System.Management.Automation.ErrorRecord(urexception, urexception.StatusCode.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new {  body=HostPoolControlParameter})
                    {
        ...
        private async global::System.Threading.Tasks.Task onDefault(global::System.Net.Http.HttpResponseMessage responseMessage, global::System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210513Preview.ICloudError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError( new global::System.Management.Automation.ErrorRecord(ex, ex.Code, global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=HostPoolControlParameter })
                    {
                ...
                {
                    WriteError( new global::System.Management.Automation.ErrorRecord(new global::System.Exception($"[{code}] : {message}"), code?.ToString(), global::System.Management.Automation.ErrorCategory.InvalidOperation, new { body=HostPoolControlParameter })
                    {
