namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview
{
    ...
    public partial class ExpandMsixImageProperties :
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview.IExpandMsixImageProperties,
        Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview.IExpandMsixImagePropertiesInternal
    {
        ...
        /// <summary>Backing field for <see cref="PackageAlias" /> property.</summary>
        private string _packageAlias;

        /// <summary>Alias of MSIX Package.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Owned)]
        public string PackageAlias { get => this._packageAlias; set => this._packageAlias = value; }

        /// <summary>Backing field for <see cref="PackageApplication" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview.IMsixPackageApplications[] _packageApplication;

        /// <summary>List of package applications.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview.IMsixPackageApplications[] PackageApplication { get => this._packageApplication; set => this._packageApplication = value; }

        /// <summary>Backing field for <see cref="PackageDependency" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview.IMsixPackageDependencies[] _packageDependency;

        /// <summary>List of package dependencies.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Owned)]
        public Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Models.Api20210401Preview.IMsixPackageDependencies[] PackageDependency { get => this._packageDependency; set => this._packageDependency = value; }
        ...
        /// <summary>Backing field for <see cref="PackageFullName" /> property.</summary>
        private string _packageFullName;

        /// <summary>Package Full Name from appxmanifest.xml.</summary>
        [Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Origin(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.PropertyOrigin.Owned)]
        public string PackageFullName { get => this._packageFullName; set => this._packageFullName = value; }
        ...
        /// <summary>Creates an new <see cref="ExpandMsixImageProperties" /> instance.</summary>
    ...
    /// Schema for Expand MSIX Image properties.
    internal partial interface IExpandMsixImagePropertiesInternal
