...
namespace Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support
{
        ...
        System.IEquatable<Status>
    {
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status Available = @"Available";

        /// <summary>The Session Host is unavailable because it is currently disconnected.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status Disconnected = @"Disconnected";

        /// <summary>SessionHost's domain trust relationship lost</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status DomainTrustRelationshipLost = @"DomainTrustRelationshipLost";

        /// <summary>FSlogix is in an unhealthy state on the session host.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status FsLogixNotHealthy = @"FSLogixNotHealthy";
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status NeedsAssistance = @"NeedsAssistance";

        /// <summary>The Session Host is not heart beating.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status NoHeartbeat = @"NoHeartbeat";

        /// <summary>SessionHost is not joined to domain.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status NotJoinedToDomain = @"NotJoinedToDomain";

        /// <summary>
        /// Session Host is shutdown - RD Agent reported session host to be stopped or deallocated.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status Shutdown = @"Shutdown";

        /// <summary>SxS stack installed on the SessionHost is not ready to receive connections.</summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status SxSStackListenerNotReady = @"SxSStackListenerNotReady";
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status Unavailable = @"Unavailable";

        /// <summary>
        /// Session Host is unavailable because the critical component upgrade (agent, side-by-side stack, etc.) failed.
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status UpgradeFailed = @"UpgradeFailed";
        ...
        /// </summary>
        public static Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status Upgrading = @"Upgrading";
        ...
        public bool Equals(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status e)
        {
        ...
        public static implicit operator string(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status e)
        {
            return e._value;
        }
        ...
        public static bool operator !=(Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status e1, Microsoft.Azure.PowerShell.Cmdlets.DesktopVirtualizationApi.Support.Status e2)
        {
            return !e2.Equals(e1);
        }
